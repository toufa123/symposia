...
final class TabActivation extends Tab {
    ...
    public function add_settings() {
        ...
        /** Activation Tab. */
        register_setting( 'SynopterElementorActivationOptionsGroup', 'envato_purchase_code_' . EnvatoItem::get_instance()->get_id() );
        add_settings_section( 'mdp_synopter_elementor_settings_page_activation_section', '', null, 'SynopterElementorActivationOptionsGroup' );
    ...
    public function do_settings() {
        ...
        /** Render fields. */
        settings_fields( 'SynopterElementorActivationOptionsGroup' );
        do_settings_sections( 'SynopterElementorActivationOptionsGroup' );
	...
	public function display_status() {
		...
		$activation_tab = admin_url( 'admin.php?page=mdp_synopter_elementor_settings&tab=activation' );
		?>

        <hr class="mdc-list-divider">
        <h6 class="mdc-list-group__subheader"><?php esc_html_e( 'CodeCanyon License', 'synopter-elementor' ); ?></h6>
		...
		<?php if ( $this->is_activated() ) : ?>
            <a class="mdc-list-item mdp-activation-status activated" href="<?php echo esc_url( $activation_tab ); ?>">
                ...
                <span class="mdc-list-item__text"><?php esc_html_e( 'Activated', 'synopter-elementor' ); ?></span>
            </a>
		<?php else : ?>
            <a class=" mdc-list-item mdp-activation-status not-activated" href="<?php echo esc_url( $activation_tab ); ?>">
                ...
                <span class="mdc-list-item__text"><?php esc_html_e( 'Not Activated', 'synopter-elementor' ); ?></span>
            </a>
		<?php endif;
	...
	public function render_subscribe() {
        ...
        <div class="mdp-subscribe-form">
            ...
            <h3><?php esc_html_e( 'Subscribe to updates', 'synopter-elementor' ); ?></h3>
            <p><?php esc_html_e( 'Sign up for the newsletter to be the first to know about news and discounts.', 'synopter-elementor' ); ?></p>
            <p class="mdp-subscribe-form-message"
               data-success="<?php esc_html_e( 'Hurray! We received your Subscription request. Check your inbox for an email from us.', 'synopter-elementor' ); ?>"
               data-warn="<?php esc_html_e( 'Oh! Sorry, but we cannot send messages to this email.', 'synopter-elementor' ); ?>"
               data-error="<?php esc_html_e( 'Oops! Something went wrong. Please try later.', 'synopter-elementor' ); ?>"
            ></p>
            ...
            UI::get_instance()->render_input(
                '',
                esc_html__( 'Your Name', 'synopter-elementor' ),
                '',
                [
            ...
            UI::get_instance()->render_input(
                '',
                esc_html__( 'Your E-Mail', 'synopter-elementor' ),
                '',
                [
            ...
            UI::get_instance()->render_button(
                esc_html__( 'Subscribe', 'synopter-elementor' ),
                '',
                false,
                [
                    "name"  => "mdp-subscribe",
	...
	public function render_form() {
        ...
        <div class="mdp-activation-form">
            <h3><?php esc_html_e( 'Plugin Activation', 'synopter-elementor' ); ?></h3>
            <?php

            /** Render input. */
            UI::get_instance()->render_input(
                $purchase_code,
                esc_html__( 'Purchase code', 'synopter-elementor'),
                esc_html__( 'Enter your CodeCanyon purchase code. Allowed only one Purchase Code per website.', 'synopter-elementor' ),
                [
    ...
    public function render_FAQ() {
        ...
        <div class="mdp-activation-faq">
            <div class="mdc-accordion" data-mdp-accordion="showfirst: true">
                ...
                <h3><?php esc_html_e( 'Activation FAQ\'S', 'synopter-elementor' ); ?></h3>

                <div class="mdc-accordion-title">
                    <i class="material-icons">help</i>
                    <span class="mdc-list-item__text"><?php esc_html_e( 'Where is my Purchase Code?', 'synopter-elementor' ); ?></span>
                </div>
                <div class="mdc-accordion-content">
                    <p><?php esc_html_e( 'The purchase code is a unique combination of characters that confirms that you bought the plugin. You can find your purchase code in ', 'synopter-elementor' ); ?>
                        <a href="https://1.envato.market/cc-downloads" target="_blank"><?php esc_html_e( 'your account', 'synopter-elementor' );?></a>
                        <?php esc_html_e( ' on the CodeCanyon. Learn more about ', 'synopter-elementor' ); ?>
                        <a href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-" target="_blank"><?php esc_html_e( 'How to find your purchase code', 'synopter-elementor' );?></a>
                        <?php esc_html_e( ' .', 'synopter-elementor');?>
                    </p>
                </div>

                <div class="mdc-accordion-title">
                    <i class="material-icons">help</i>
                    <span class="mdc-list-item__text"><?php esc_html_e( 'Can I use one Purchase Code on multiple sites?', 'synopter-elementor' ); ?></span>
                </div>
                <div class="mdc-accordion-content">
                    <p>
                        <?php esc_html_e( 'No, this is prohibited by license terms. You can use the purchase code on only one website at a time. Learn more about ', 'synopter-elementor' ); ?>
                        <a href="https://1.envato.market/KYbje" target="_blank"><?php esc_html_e( 'Envato License', 'synopter-elementor' );?></a>
                        <?php esc_html_e( ' terms. ', 'synopter-elementor' ); ?>
                    </p>
                </div>

                <div class="mdc-accordion-title">
                    <i class="material-icons">help</i>
                    <span class="mdc-list-item__text"><?php esc_html_e( 'What are the benefits of plugin activation?', 'synopter-elementor' ); ?></span>
                </div>
                <div class="mdc-accordion-content">
                    <p>
                        <?php esc_html_e( 'Activation of the plugin allows you to use all the functionality of the plugin on your site. In addition, in some cases, activating the plugin allows you to access additional features and capabilities of the plugin. Also, using an authored version of the plugin, you can be sure that you will not violate the license.', 'synopter-elementor' ); ?>
                    </p>
                </div>

                <div class="mdc-accordion-title">
                    <i class="material-icons">help</i>
                    <span class="mdc-list-item__text"><?php esc_html_e( 'What should I do if my Purchase Code does not work?', 'synopter-elementor' ); ?></span>
                </div>
                <div class="mdc-accordion-content">
                    <p>
                        <?php esc_html_e( 'There are several reasons why the purchase code may not work on your site. Learn more why your ', 'synopter-elementor' ); ?>
                        <a href="https://merkulove.zendesk.com/hc/en-us/articles/360006100998-Troubleshooting-of-the-plugin-activation" target="_blank"><?php esc_html_e( 'Purchase Code is Not Working', 'synopter-elementor' );?></a>
                        <?php esc_html_e( ' .', 'synopter-elementor');?>
                    </p>
                </div>
