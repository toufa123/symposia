...
( function ( $ ) {
    ...
    $( document ).ready( function () {
        ...
        let mdpSynopterElementor = window.mdpSynopterElementor;
        ...
        $checkUpdatesBtn.on( 'click', function ( e ) {
            ...
            let data = {
                ...
                nonce: mdpSynopterElementor.nonce,
                checkUpdates: true
            };

            /** Do AJAX request. */
            $.post( mdpSynopterElementor.ajaxURL, data, function( response ) {
