...
abstract class Tab {
    ...
    protected function do_settings_base( $tab_slug = null ) {
        ...
        settings_fields( 'SynopterElementor' . $tab_slug . 'OptionsGroup' );
        do_settings_sections( 'SynopterElementor' . $tab_slug. 'OptionsGroup' );
    ...
    protected function add_settings_base( $tab_slug = null ) {
        ...
        /** Status Tab. */
        register_setting( 'SynopterElementor' . $tab_slug . 'OptionsGroup', 'mdp_synopter_elementor_' . $tab_slug . '_settings' );
        add_settings_section( 'mdp_synopter_elementor_' . $tab_slug . '_page_status_section', '', null, 'SynopterElementor' . $tab_slug . 'OptionsGroup' );
