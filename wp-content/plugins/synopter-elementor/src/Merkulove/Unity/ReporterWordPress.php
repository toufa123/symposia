...
final class ReporterWordPress {
	...
	public function get_title() {
        ...
        return esc_html__( 'WordPress Environment', 'synopter-elementor' );
	...
	public function get_fields() {
		...
		return [
			'version'               => esc_html__( 'Version', 'synopter-elementor' ),
			'site_url'              => esc_html__( 'Site URL', 'synopter-elementor' ),
			'home_url'              => esc_html__( 'Home URL', 'synopter-elementor' ),
			'is_multisite'          => esc_html__( 'WP Multisite', 'synopter-elementor' ),
			'max_upload_size'       => esc_html__( 'Max Upload Size', 'synopter-elementor' ),
			'memory_limit'          => esc_html__( 'Memory limit', 'synopter-elementor' ),
			'permalink_structure'   => esc_html__( 'Permalink Structure', 'synopter-elementor' ),
			'language'              => esc_html__( 'Language', 'synopter-elementor' ),
			'timezone'              => esc_html__( 'Timezone', 'synopter-elementor' ),
			'admin_email'           => esc_html__( 'Admin Email', 'synopter-elementor' ),
			'debug_mode'            => esc_html__( 'Debug Mode', 'synopter-elementor' ),
		];
	...
	public function get_memory_limit() {
		...
		if ( $memory_limit_bytes < $min_recommended_bytes ) {
			$result['recommendation'] = esc_html__( 'We recommend setting memory to at least 64M. For more information, ask your hosting provider.', 'synopter-elementor' );
	...
	public function get_is_multisite() {
		...
		return [
			'value' => is_multisite() ? esc_html__( 'Yes', 'synopter-elementor' ) : esc_html__( 'No', 'synopter-elementor' )
		];
	...
	public function get_permalink_structure() {
		...
		if ( ! $structure ) {
			$structure = esc_html__( 'Plain', 'synopter-elementor' );
		}
	...
	public function get_debug_mode() {
		...
		return [
			'value' => WP_DEBUG ? esc_html__( 'Active', 'synopter-elementor' ) : esc_html__( 'Inactive', 'synopter-elementor' )
		];
