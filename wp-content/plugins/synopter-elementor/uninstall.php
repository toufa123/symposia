...
use Merkulove\SynopterElementor\Unity\Cache;
use Merkulove\SynopterElementor\Unity\Helper;
use Merkulove\SynopterElementor\Unity\Plugin;
use Merkulove\SynopterElementor\UninstallHelper;
use Merkulove\SynopterElementor\Unity\EnvatoItem;
...
final class Uninstall {
    ...
    private function remove_settings() {
        ...
        foreach ( wp_load_alloptions() as $option => $value ) {
            if ( strpos( $option, 'mdp_synopter_elementor' ) === 0 ) {
                $settings[] = $option;
            }
        }
    ...
    public function get_uninstall_mode() {
        ...
        if ( isset( $uninstall_settings[ 'mdp_synopter_elementor_uninstall_settings' ] ) && $uninstall_settings[ 'mdp_synopter_elementor_uninstall_settings' ] ) { // Default value.
            $uninstall_settings = [
