 ...
 *
 * @wordpress-plugin
 * Plugin Name: Synopter for Elementor
 * Plugin URI: https://1.envato.market/synopter-elementor
 * Description: Weekly, Daily and Hourly weather forecast for Elementor
 * Version: 1.1.1
 ...
 * Text Domain: synopter-elementor
...
use Merkulove\SynopterElementor\Caster;
use Merkulove\SynopterElementor\Config;
use Merkulove\SynopterElementor\Unity\Unity;
 ...
 *
 **/
final class SynopterElementor {

    /**
     * The one true SynopterElementor.
     *
     * @var SynopterElementor
     * @since 1.0.0
     * @access private
     **/
	...
	public static function on_activation() {
        ...
        /** Call Synopter on plugin activation */
...
register_activation_hook( __FILE__, [ SynopterElementor::class, 'on_activation' ] );

/** Run 'on_deactivation' when the plugin is deactivated. */
register_deactivation_hook( __FILE__, [ SynopterElementor::class, 'on_deactivation' ] );

/** Run Plugin class once after activated plugins have loaded. */
add_action( 'plugins_loaded', [ SynopterElementor::get_instance(), 'setup' ] );
