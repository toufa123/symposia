...
Tags: flickr, flickr album gallery, flickr photo gallery, flickr image gallery, flickr widget
...
Flickr Album Image Gallery is based on Flickr JS API. Use the Flickr image gallery plugin to display all your Flickr Albums on your WordPress Blog Site. You can use your own Flickr API and Flickr Album ID to publish Flickr Albums on your WordPress Blog website.
