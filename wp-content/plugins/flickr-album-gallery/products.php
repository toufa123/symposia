		...
		<div class="wpfrank-products-container">
			...
			<div class="wpfrank-products">
				...
				<div class="wpfrank-product">
					...
					<img class="wpfrank-product-image" src="<?php echo esc_url( FAG_PLUGIN_URL . 'img/products/Slider-Factory-Pro.png' ); ?>">
					<div class="wpfrank-product-tagline">The best WordPress Slider plugin to add automatic slide show on the website with multiple design layouts.</div>
					<div class="wpfrank-product-links">
