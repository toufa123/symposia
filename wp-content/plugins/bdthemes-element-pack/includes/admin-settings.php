    ...
    protected function element_pack_admin_settings() {
        $settings_fields = [
            'element_pack_active_modules' => [
                ...
                //     'demo_url'     => 'https://elementpack.pro/demo/element/animated-card/',
                //     'video_url'    => '',
                // ],
                [
                ...
                //     'widget_type'  => 'free',
                //     'content_type' => 'others new',
                //     'demo_url'     => 'https://elementpack.pro/demo/element/animated-link/',
                //     'video_url'    => '',
                // ],
                [
                    'name'         => 'audio-player',
                ...
                //     'widget_type'  => 'free',
                //     'content_type' => 'custom new',
                //     'demo_url'     => 'https://elementpack.pro/demo/element/brand-grid',
                //     'video_url'    => '',
                // ],
                // [
                //     'name'         => 'brand-carousel',
                ...
                //     'widget_type'  => 'free',
                //     'content_type' => 'custom new',
                //     'demo_url'     => 'https://elementpack.pro/demo/element/brand-carousel',
                //     'video_url'    => '',
                // ],
                [
                    'name'         => 'business-hours',
                ...
                //     'widget_type'  => 'pro',
                //     'content_type' => 'others new',
                //     'demo_url'     => 'https://elementpack.pro/demo/element/creative-button/',
                //     'video_url'    => '',
                // ],
                [
                    'name'         => 'coupon-code',
                ...
                //     'widget_type'  => 'free',
                //     'content_type' => 'custom new',
                //     'demo_url'     => 'https://elementpack.pro/demo/element/review-card-grid/',
                //     'video_url'    => '',
                // ],
                // [
                ...
                //     'demo_url'     => 'https://elementpack.pro/demo/element/review-card-carousel/',
                //     'video_url'    => '',
                // ],
                [
                    'name'         => 'slider',
            ...
            <div class="bdt-grid bdt-hidden@xl" bdt-grid bdt-height-match="target: > div > .bdt-card">
                <div class=" ep-welcome-banner">
                    <div class="ep-welcome-content bdt-card bdt-card-body">
                        ...
                        <a class="bdt-button bdt-btn-red bdt-margin-small-top bdt-margin-small-right" target="_blank" rel="" href="https://elementpack.pro/support/element-pack-knowledge-base/">Read Knowledge Base</a>
            ...
            <div class="bdt-grid" bdt-grid bdt-height-match="target: > div > .bdt-card">
                <div class="bdt-width-1-3@m ep-support-section">
                    <div class="ep-support-content bdt-card bdt-card-green bdt-card-body">
                        ...
                        <p>Feeling like to consult with an expert? Take live Chat support immediately from <a href="https://elementpack.pro" target="_blank" rel="">ElementPack</a>. We are always ready to help
                            you 24/7.</p>
                        <p><strong>Or if you’re facing technical issues with our plugin, then please create a support
                                ticket</strong></p>
                        <a class="bdt-button bdt-btn-green bdt-margin-small-top bdt-margin-small-right" target="_blank" href="https://elementpack.pro/go/support/">Get Support</a>
                        <a class="bdt-button bdt-btn-red bdt-margin-small-top" target="_blank" rel="" href="https://elementpack.pro/support/element-pack-knowledge-base/">Go knowledge page</a>
                    </div>
                </div>
