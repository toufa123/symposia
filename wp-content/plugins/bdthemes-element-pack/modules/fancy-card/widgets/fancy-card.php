...
class Fancy_Card extends Module_Base {
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-card .bdt-content' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-card .bdt-fancy-icon' => 'justify-content: {{VALUE}};',
				],
				'condition' => [
					'_skin!' => 'flux',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-readmore .bdt-button-icon-align-right' => is_rtl() ? 'margin-right: {{SIZE}}{{UNIT}};' : 'margin-left: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .bdt-readmore .bdt-button-icon-align-left'  => is_rtl() ? 'margin-left: {{SIZE}}{{UNIT}};' : 'margin-right: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-icon' => 'margin-top: -{{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-icon' => 'transform: translateX({{SIZE}}{{UNIT}});',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-icon' => 'margin-left: -{{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-icon' => 'margin-right: -{{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-icon' => 'transform: translateY({{SIZE}}{{UNIT}});',
				],
			]
		);
		...
		$this->add_control(
            ...
            [
                ...
                'selectors'   => [
                    '{{WRAPPER}} .bdt-fancy-card .bdt-fancy-icon' => 'backdrop-filter: blur({{SIZE}}px); -webkit-backdrop-filter: blur({{SIZE}}px);'
				],
				'condition' => [
					'_skin' => '',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-card .bdt-fancy-icon' => 'background: {{VALUE}};',
				],
				'condition' => [
					'_skin!' => 'batty',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'label'     => __( 'Primary Background', 'bdthemes-element-pack' ),
				'types'     => [ 'gradient' ],
				'selector'  => '{{WRAPPER}} .bdt-fancy-card.bdt-skin-batty .bdt-batty-face.bdt-batty-face2',
				'condition' => [
					'_skin' => 'batty',
				],
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-fancy-card .bdt-fancy-icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
					'_skin!' => 'batty',
				],
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-card .bdt-fancy-icon:before' => 'color: {{VALUE}};',
				],
				'condition' => [
					'_skin!' => ['batty']
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .bdt-fancy-card .bdt-fancy-icon:before',
				'condition' => [
					'_skin!' => ['batty']
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-card:hover .bdt-fancy-icon' => 'background: {{VALUE}};',
				],
				'condition' => [
					'_skin!' => 'batty',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'label'     => __( 'Primary Background', 'bdthemes-element-pack' ),
				'types'     => [ 'gradient' ],
				'selector'  => '{{WRAPPER}} .bdt-fancy-card.bdt-skin-batty:hover .bdt-batty-face.bdt-batty-face2',
				'condition' => [
					'_skin' => 'batty',
				],
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-fancy-card:hover .bdt-fancy-icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
					'_skin!' => 'batty',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'separator' => 'before',
				'selector'  => '{{WRAPPER}} .bdt-fancy-card:hover .bdt-icon-wrapper:after, {{WRAPPER}} .bdt-skin-flux:hover .bdt-icon-wrapper',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-card:hover .bdt-fancy-icon:before' => 'color: {{VALUE}};',
				],
				'condition' => [
					'_skin!' => 'batty'
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .bdt-fancy-card:hover .bdt-fancy-icon:before',
				'condition' => [
					'_skin!' => 'batty'
				],
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-content .bdt-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bdt-content .bdt-title',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-card:hover .bdt-content .bdt-title' => 'color: {{VALUE}};',
				],
				'condition' =>[
					'_skin!' => 'batty',
				]
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bdt-fancy-card:hover .bdt-content .bdt-title',
				'condition' =>[
					'_skin!' => 'batty',
				]
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'      => Controls_Manager::SLIDER,
				'selectors' => [
					'{{WRAPPER}} .bdt-content .bdt-text' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-content .bdt-text' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bdt-content .bdt-text',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-card:hover .bdt-content .bdt-text' => 'color: {{VALUE}};',
				],
				'condition' =>[
					'_skin!' => 'batty',
				]
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bdt-fancy-card:hover .bdt-content .bdt-text',
				'condition' =>[
					'_skin!' => 'batty',
				]
			]
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-card .bdt-content .bdt-readmore' => 'color: {{VALUE}};',
					'{{WRAPPER}} .bdt-fancy-card .bdt-content .bdt-readmore svg *' => 'stroke: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .bdt-fancy-card .bdt-content .bdt-readmore', 
				'separator' => 'before', 
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'separator'  => 'after', 
				'selectors'  => [
					'{{WRAPPER}} .bdt-fancy-card .bdt-content .bdt-readmore' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-fancy-card .bdt-content .bdt-readmore' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-card .bdt-content .bdt-readmore:hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} .bdt-fancy-card .bdt-content .bdt-readmore:hover svg *' => 'stroke: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .bdt-fancy-card .bdt-content .bdt-readmore:hover',
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-card .bdt-content .bdt-readmore:hover' => 'border-color: {{VALUE}};',
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-card.bdt-skin-climax input:checked~.bdt-fancy-card-toggole' => 'box-shadow: 0 0 0 1920px {{VALUE}};',
					'{{WRAPPER}} .bdt-fancy-card.bdt-skin-climax .bdt-fancy-card-toggole' => 'box-shadow: 0 0 0 0 {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-card.bdt-skin-climax .bdt-fancy-card-toggole' => 'color: {{VALUE}};',
					'{{WRAPPER}} .bdt-fancy-card.bdt-skin-climax .bdt-fancy-card-toggole svg *' => 'stroke: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .bdt-fancy-card.bdt-skin-climax .bdt-fancy-card-toggole',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-fancy-card.bdt-skin-climax .bdt-fancy-card-toggole' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-card.bdt-skin-climax input[type="checkbox"], {{WRAPPER}} .bdt-fancy-card.bdt-skin-climax .bdt-fancy-card-toggole' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}; line-height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-card.bdt-skin-climax input:checked~.bdt-fancy-card-toggole' => 'color: {{VALUE}};',
					'{{WRAPPER}} .bdt-fancy-card.bdt-skin-climax input:checked~.bdt-fancy-card-toggole svg *' => 'stroke: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .bdt-fancy-card.bdt-skin-climax input:checked~.bdt-fancy-card-toggole',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-card.bdt-skin-climax input:checked~.bdt-fancy-card-toggole' => 'border-color: {{VALUE}};',
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-card.bdt-skin-stack .bdt-content-overlay:before'  => 'background: {{VALUE}};',
					'{{WRAPPER}} .bdt-fancy-card.bdt-skin-batty'  => 'background: {{VALUE}} !important;',
				],
				'condition' => [
					'_skin!' => ['', 'climax', 'flux'],
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bdt-fancy-card, {{WRAPPER}} .bdt-skin-batty',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-fancy-card .bdt-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				],
				'separator' => 'before',
			]
		);
	...
	public function render_icon() {
		...
		<?php if ( $has_icon or $has_image ) : ?>
			<div class="bdt-fancy-icon" data-label="<?php echo $data_label; ?>" >
	...
	public function render_title() {
		...
		$this->add_render_attribute( 'fancy-card-title', 'class', 'bdt-title' );
	...
	public function render_text() {
		...
		$this->add_render_attribute( 'description_text', 'class', 'bdt-text' );
	...
	public function render_readmore() {
		...
		$this->add_render_attribute( 'readmore', 'class', ['bdt-readmore', 'bdt-display-inline-block'] );
	...
	public function render() {
		...
		if ( 'left' == $settings['fancy_card_icon_position'] ) {
			$this->add_render_attribute( 'fancy-card', 'class', 'bdt-fancy-card bdt-skin-default bdt-fancy-icon-left' );
		} elseif ( 'right' == $settings['fancy_card_icon_position'] ) {
			$this->add_render_attribute( 'fancy-card', 'class', 'bdt-fancy-card bdt-skin-default bdt-fancy-icon-right' );
		} elseif ( '' == $settings['fancy_card_icon_position'] ) {
			$this->add_render_attribute( 'fancy-card', 'class', 'bdt-fancy-card bdt-skin-default bdt-fancy-icon-default' );
		} else {
			$this->add_render_attribute( 'fancy-card', 'class', 'bdt-fancy-card bdt-skin-default' );
		}
