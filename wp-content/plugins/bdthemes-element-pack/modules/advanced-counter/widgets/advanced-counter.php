	...
	class Advanced_Counter extends Module_Base {
		...
		protected function _register_controls() {
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors'  => [
						'{{WRAPPER}} .bdt-advanced-counter .bdt-advanced-counter-content-text' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
		...
		protected function render() {
			...
			if ( $settings['counter_text_inline'] == 'yes' ) {
				$this->add_render_attribute( 'content_wrap', 'class', 'bdt-advanced-counter-content bdt-flex-inline bdt-flex-middle' );
			} else {
				$this->add_render_attribute( 'content_wrap', 'class', 'bdt-advanced-counter-content' );
			}
