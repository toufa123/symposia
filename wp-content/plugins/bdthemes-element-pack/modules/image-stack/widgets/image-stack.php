	...
	protected function _register_controls() {
		...
		$repeater->add_control(
            'icon_color', 
             [
                ...
                'selectors' => [
                    '{{WRAPPER}} .bdt-image-stack .bdt-ep-image-stack-item{{CURRENT_ITEM}} i' => 'color: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-image-stack-item i' => 'color: {{VALUE}}',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-image-stack-item:hover i' => 'color: {{VALUE}}',
