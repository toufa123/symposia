...
class Advanced_Gmap extends Module_Base {
	...
	public function get_script_depends() {
		return ['gmap-api', 'gmap', 'smooth-scrollbar'];
	}
	...
	public function render() {
		...
		$map_settings['zoom']              =  (int) $settings['avd_google_map_default_zoom']['size'];
							...
							<div class="bdt-gmap-search-wrapper">
								<form class="bdt-search bdt-search-default">
									<div class="search-box">
										<input type="text" placeholder="search places" class="bdt-search-input" />
									</div>
								</form>
							</div>
						<?php endif; ?>
