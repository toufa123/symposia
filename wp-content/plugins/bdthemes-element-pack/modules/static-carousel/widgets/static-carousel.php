...
class Static_Carousel extends Module_Base {
    ...
    public function get_style_depends() {
        if ($this->ep_is_edit_mode()) {
            ...
            return ['element-pack-font', 'ep-static-carousel'];
        }
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bdt-ep-static-carousel-readmore svg *' => 'stroke: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bdt-ep-static-carousel-readmore:hover svg *' => 'stroke: {{VALUE}};',
				],
			]
		);
        ...
        $this->register_navigation_style_controls('static-carousel');
