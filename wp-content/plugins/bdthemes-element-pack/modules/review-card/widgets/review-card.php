...
class Review_Card extends Module_Base {
    ...
    public function get_style_depends() {
        if ($this->ep_is_edit_mode()) {
            ...
            return ['element-pack-font', 'ep-review-card'];
        }
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '#e7e7e7',
                'selectors' => [
                    '{{WRAPPER}} .bdt-ep-review-card-rating i.ep-icon-star-empty' => 'color: {{VALUE}};',
                ],
                'condition' => [
                    'rating_type' => 'star',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '#FFCC00',
                'selectors' => [
                    '{{WRAPPER}} .bdt-ep-review-card-rating i.ep-icon-star-full' => 'color: {{VALUE}};',
                ],
                'condition' => [
                    'rating_type' => 'star',
                ],
    ...
    public function render_review_rating() {
        ...
        <div class="bdt-ep-review-card-rating bdt-flex-inline bdt-flex-middle bdt-<?php echo esc_attr($settings['rating_type']) ?> bdt-<?php echo esc_attr($settings['rating_position']) ?>">
            ...
            <?php else :
                for ( $i = 1; $i <= 5; ++$i ) :
                    if ( $i <= $settings['rating_number']['size'] ) {
                        echo '<i class="ep-icon-star-full" aria-hidden="true"></i>';
                    } else {
                        echo '<i class="ep-icon-star-empty" aria-hidden="true"></i>';
                    }
                endfor;
            endif; ?>
        </div>
