...
class Helper
{
    use \DynamicContentForElementor\Trait_Plugin;
    use \DynamicContentForElementor\Trait_FileSystem;
    use \DynamicContentForElementor\Trait_WP;
    use \DynamicContentForElementor\Trait_Meta;
    use \DynamicContentForElementor\Trait_Elementor;
    use \DynamicContentForElementor\Trait_Form;
    use \DynamicContentForElementor\Trait_String;
    use \DynamicContentForElementor\Trait_Image;
