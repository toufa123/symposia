	...
	public static function get_all_features_data() {
		return [
			...
			'ext_conditional_fields_v2' => [
				...
				'description' => __( 'Contains the extensions: Conditional Fields, Conditional Validation, Conditional Mailchimp, Conditional Active Campaign, Conditional Webhook, and Max Submissions for Elementor Pro Form', 'dynamic-content-for-elementor' ),
				'icon' => 'icon-dyn-conditional-fields',
				'plugin_depends' => [ 'elementor-pro' ],
