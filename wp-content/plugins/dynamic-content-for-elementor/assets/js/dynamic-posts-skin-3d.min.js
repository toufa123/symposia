var scene3d_istance=null;var Widget_DCE_Dynamicposts_3d_Handler=function($scope,$){var elementSettings=dceGetElementSettings($scope);var scene3d=$scope.find('.dce-posts-container.dce-skin-3d');var postsList=$scope.find('.dce-3d-wrapper .dce-item-3d');var is3dEnabled=!1;var isAnimating=!1;var elementsQuantity=postsList.length;var camera,scene,renderer,group;var controls;var objects=[];var targets={fila:[],circle:[],sphere:[],helix:[],grid:[]};var targets1={fila:[],circle:[],sphere:[],helix:[],grid:[]};var mouseX=0,mouseY=0;var windowHalfX=window.innerWidth/2;var windowHalfY=window.innerHeight/2;var targetSelect;var panelWidth=Number(elementSettings[dceDynamicPostsSkinPrefix+'size_plane_3d'])||320;var panelSpace=400;var distanza=1000;var diametro=(elementsQuantity*(panelWidth+panelSpace))/Math.PI;var raggio=diametro/2;var camDefaultZ=raggio+distanza;var camDefaultY=300;var eneableblur=Boolean(elementSettings[dceDynamicPostsSkinPrefix+'blur_depth_3d'])||!1
