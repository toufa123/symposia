...
hiddenInput.value=result;visibleInput.value=textBefore+result+textAfter;if("createEvent" in document){var evt=document.createEvent("HTMLEvents");evt.initEvent("change",!1,!0);hiddenInput.dispatchEvent(evt)}else{hiddenInput.fireEvent("onchange")}}
