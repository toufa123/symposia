...
namespace DynamicOOOS\TelegramBot\Api\Types\Inline;

use DynamicOOOS\TelegramBot\Api\BaseType;
use DynamicOOOS\TelegramBot\Api\Types\Location;
...
class ChosenInlineResult extends BaseType
{
     ...
     * @var array
     */
    protected static $map = ['result_id' => \true, 'from' => User::class, 'location' => Location::class, 'inline_message_id' => \true, 'query' => \true];
    /**
