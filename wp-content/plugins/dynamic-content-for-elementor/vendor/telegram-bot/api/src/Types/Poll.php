...
class Poll extends BaseType implements TypeInterface
{
     ...
     * @var array
     */
    protected static $requiredParams = ['id', 'question', 'options', 'total_voter_count', 'is_closed', 'is_anonymous', 'type', 'allows_multiple_answers'];
    /**
     * {@inheritdoc}
     *
     * @var array
     */
    protected static $map = ['id' => \true, 'question' => \true, 'options' => ArrayOfPollOption::class, 'total_voter_count' => \true, 'is_closed' => \true, 'is_anonymous' => \true, 'type' => \true, 'allows_multiple_answers' => \true, 'correct_option_id' => \true];
    /**
