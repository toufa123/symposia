...
class Voice extends AbstractInlineQueryResult
{
     ...
     * @var array
     */
    protected static $map = ['type' => \true, 'id' => \true, 'voice_url' => \true, 'title' => \true, 'voice_duration' => \true, 'reply_markup' => InlineKeyboardMarkup::class, 'input_message_content' => InputMessageContent::class];
    /**
     * {@inheritdoc}
     *
     * @var string
