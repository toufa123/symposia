...
use DynamicOOOS\TelegramBot\Api\Types\Inline\ChosenInlineResult;
use DynamicOOOS\TelegramBot\Api\Types\Inline\InlineQuery;
use DynamicOOOS\TelegramBot\Api\Types\Payments\Query\PreCheckoutQuery;
use DynamicOOOS\TelegramBot\Api\Types\Payments\Query\ShippingQuery;
/**
 * Class Update
...
class Update extends BaseType implements TypeInterface
{
     ...
     * @var array
     */
    protected static $map = ['update_id' => \true, 'message' => Message::class, 'edited_message' => Message::class, 'channel_post' => Message::class, 'edited_channel_post' => Message::class, 'inline_query' => InlineQuery::class, 'chosen_inline_result' => ChosenInlineResult::class, 'callback_query' => CallbackQuery::class, 'shipping_query' => ShippingQuery::class, 'pre_checkout_query' => PreCheckoutQuery::class, 'poll_answer' => PollAnswer::class, 'poll' => Poll::class];
    /**
