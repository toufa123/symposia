...
use DynamicOOOS\Payum\ISO4217\ISO4217;
class ISO4217Test extends \DynamicOOOS\PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testFindByAlpha3($alpha3, array $expected)
    {
        ...
        $this->assertInstanceOf('DynamicOOOS\\Payum\\ISO4217\\Currency', $currency);
    ...
    public function testFindByAlpha3MustReturnSameInstance($alpha3, array $expected)
    {
        ...
        $this->assertInstanceOf('DynamicOOOS\\Payum\\ISO4217\\Currency', $firstCurrency);
        $this->assertInstanceOf('DynamicOOOS\\Payum\\ISO4217\\Currency', $secondCurrency);
    ...
    public function testFindAll()
    {
        ...
        $this->assertContainsOnly('DynamicOOOS\\Payum\\ISO4217\\Currency', $currencies);
    }
    /**
     * @return array
     */
    ...
    {
        $rp = new \ReflectionProperty('DynamicOOOS\\Payum\\ISO4217\\ISO4217', 'rawCurrencies');
        $rp->setAccessible(\true);
        $currencies = $rp->getValue('DynamicOOOS\\Payum\\ISO4217');
        $rp->setAccessible(\false);
        return \array_reduce($currencies, function (array $carry, array $currency) use($indexedBy) {
