...
namespace DynamicOOOS\Dompdf\Adapter;

use DynamicOOOS\Dompdf\Canvas;
use DynamicOOOS\Dompdf\Dompdf;
use DynamicOOOS\Dompdf\Helpers;
use DynamicOOOS\Dompdf\Exception;
use DynamicOOOS\Dompdf\Image\Cache;
use DynamicOOOS\Dompdf\PhpEvaluator;
/**
...
class CPDF implements Canvas
{
     ...
     * @var array;
     */
    static $PAPER_SIZES = array("4a0" => array(0, 0, 4767.87, 6740.79), "2a0" => array(0, 0, 3370.39, 4767.87), "a0" => array(0, 0, 2383.94, 3370.39), "a1" => array(0, 0, 1683.78, 2383.94), "a2" => array(0, 0, 1190.55, 1683.78), "a3" => array(0, 0, 841.89, 1190.55), "a4" => array(0, 0, 595.28, 841.89), "a5" => array(0, 0, 419.53, 595.28), "a6" => array(0, 0, 297.64, 419.53), "a7" => array(0, 0, 209.76, 297.64), "a8" => array(0, 0, 147.4, 209.76), "a9" => array(0, 0, 104.88, 147.4), "a10" => array(0, 0, 73.7, 104.88), "b0" => array(0, 0, 2834.65, 4008.19), "b1" => array(0, 0, 2004.09, 2834.65), "b2" => array(0, 0, 1417.32, 2004.09), "b3" => array(0, 0, 1000.63, 1417.32), "b4" => array(0, 0, 708.66, 1000.63), "b5" => array(0, 0, 498.9, 708.66), "b6" => array(0, 0, 354.33, 498.9), "b7" => array(0, 0, 249.45, 354.33), "b8" => array(0, 0, 175.75, 249.45), "b9" => array(0, 0, 124.72, 175.75), "b10" => array(0, 0, 87.87, 124.72), "c0" => array(0, 0, 2599.37, 3676.54), "c1" => array(0, 0, 1836.85, 2599.37), "c2" => array(0, 0, 1298.27, 1836.85), "c3" => array(0, 0, 918.4299999999999, 1298.27), "c4" => array(0, 0, 649.13, 918.4299999999999), "c5" => array(0, 0, 459.21, 649.13), "c6" => array(0, 0, 323.15, 459.21), "c7" => array(0, 0, 229.61, 323.15), "c8" => array(0, 0, 161.57, 229.61), "c9" => array(0, 0, 113.39, 161.57), "c10" => array(0, 0, 79.37, 113.39), "ra0" => array(0, 0, 2437.8, 3458.27), "ra1" => array(0, 0, 1729.13, 2437.8), "ra2" => array(0, 0, 1218.9, 1729.13), "ra3" => array(0, 0, 864.5700000000001, 1218.9), "ra4" => array(0, 0, 609.45, 864.5700000000001), "sra0" => array(0, 0, 2551.18, 3628.35), "sra1" => array(0, 0, 1814.17, 2551.18), "sra2" => array(0, 0, 1275.59, 1814.17), "sra3" => array(0, 0, 907.09, 1275.59), "sra4" => array(0, 0, 637.8, 907.09), "letter" => array(0, 0, 612.0, 792.0), "half-letter" => array(0, 0, 396.0, 612.0), "legal" => array(0, 0, 612.0, 1008.0), "ledger" => array(0, 0, 1224.0, 792.0), "tabloid" => array(0, 0, 792.0, 1224.0), "executive" => array(0, 0, 521.86, 756.0), "folio" => array(0, 0, 612.0, 936.0), "commercial #10 envelope" => array(0, 0, 684, 297), "catalog #10 1/2 envelope" => array(0, 0, 648, 864), "8.5x11" => array(0, 0, 612.0, 792.0), "8.5x14" => array(0, 0, 612.0, 1008.0), "11x17" => array(0, 0, 792.0, 1224.0));
    /**
     * The Dompdf object
     *
     * @var Dompdf
    ...
    public function __construct($paper = "letter", $orientation = "portrait", Dompdf $dompdf)
    {
        ...
        $this->_dompdf = $dompdf;
        $this->_pdf = new \DynamicOOOS\Cpdf($size, \true, $dompdf->getOptions()->getFontCache(), $dompdf->getOptions()->getTempDir());
    ...
    protected function _convert_gif_bmp_to_png($image_url, $type)
    {
        ...
        if (!\function_exists($func_name)) {
            if (!\method_exists("DynamicOOOS\\Dompdf\\Helpers", $func_name)) {
        ...
        if ($im) {
            ...
            $tmp_name = @\tempnam($tmp_dir, "{$type}dompdf_img_");
            @\unlink($tmp_name);
