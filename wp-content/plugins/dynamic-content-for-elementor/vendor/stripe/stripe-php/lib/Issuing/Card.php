...
namespace DynamicOOOS\Stripe\Issuing;
 ...
 */
class Card extends \DynamicOOOS\Stripe\ApiResource
{
    ...
    public function details($params = null, $opts = null)
    {
        ...
        $obj = \DynamicOOOS\Stripe\Util\Util::convertToStripeObject($response, $opts);
