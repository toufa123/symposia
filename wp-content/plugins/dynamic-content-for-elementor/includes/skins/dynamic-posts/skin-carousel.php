...
class Skin_Carousel extends \DynamicContentForElementor\Includes\Skins\Skin_Base
{
    ...
    public function register_additional_carousel_controls()
    {
        ...
        $this->add_control('speed_slider', ['label' => __('Speed (ms)', 'dynamic-content-for-elementor'), 'description' => __('Duration of transition between slides', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::NUMBER, 'default' => 300, 'min' => 0, 'max' => 3000, 'step' => 10, 'frontend_available' => \true]);
        ...
        $this->add_responsive_control('navigation_arrow_height', ['label' => __('Size', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SLIDER, 'default' => ['size' => '80'], 'range' => ['px' => ['max' => 100, 'min' => 0, 'step' => 1]], 'selectors' => ['{{WRAPPER}} .dce-container-navigation i' => 'font-size: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-container-navigation svg' => 'height: {{SIZE}}{{UNIT}}; width: 100%;'], 'condition' => [$this->get_control_id('useNavigation') => 'yes']]);
        ...
        $this->add_control('autoplay', ['label' => __('Autoplay Delay (ms)', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::NUMBER, 'default' => '4000', 'min' => 0, 'max' => 15000, 'step' => 100, 'frontend_available' => \true, 'condition' => [$this->get_control_id('useAutoplay') => 'yes']]);
    ...
    protected function render_loop_end()
    {
        ...
        if ($this->get_instance_value('useNavigation')) {
            $this->parent->add_render_attribute('container-navigation', 'class', ['dce-container-navigation', 'swiper-container-' . $this->get_instance_value('direction_slider')]);
            $this->parent->add_render_attribute('carousel-prev', 'class', ['swiper-button-prev', 'prev-' . $this->parent->get_id()]);
            $this->parent->add_render_attribute('carousel-next', 'class', ['swiper-button-next', 'next-' . $this->parent->get_id()]);
            // Add Arrows
            ...
            if (!empty($previous_arrow['value']) || !empty($next_arrow['value'])) {
                ?>
				<div <?php 
                echo $this->parent->get_render_attribute_string('container-navigation');
                ?>>
					<?php 
                // Arrow - Previous
                ?>
					<div <?php 
                echo $this->parent->get_render_attribute_string('carousel-prev');
                ?>>
						<?php 
                ...
                ?>
					<div <?php 
                echo $this->parent->get_render_attribute_string('carousel-next');
                ?>>
						<?php 
