...
class Icons extends \DynamicContentForElementor\Extensions\DCE_Extension_Prototype
{
    ...
    {
        $widget->start_controls_section('section_dce_field_icons_style', ['label' => '<span class="color-dce icon icon-dyn-logo-dce pull-right ml-1"></span> ' . __('Icons', 'dynamic-content-for-elementor'), 'tab' => Controls_Manager::TAB_STYLE]);
