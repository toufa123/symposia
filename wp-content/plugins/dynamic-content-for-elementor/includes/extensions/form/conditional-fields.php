...
class ConditionalFields extends \DynamicContentForElementor\Extensions\DCE_Extension_Prototype
{
    public $has_action = \false;
    public $depended_scripts = ['dce-conditional-fields'];
    public $depended_styles = ['dce-conditional-fields'];
    public $conditional_actions = ['activecampaign', 'mailchimp', 'webhook'];
    ...
    {
        $widget->start_controls_section('section_max_submissions', ['label' => '<span class="color-dce icon icon-dyn-logo-dce pull-right ml-1"></span> ' . __('Max Submissions', 'dynamic-content-for-elementor')]);
    ...
    public function update_actions_controls(\Elementor\Controls_Stack $widget)
    {
        ...
        $widget->add_control("dce_action_condition_{$action}_enabled", ['label' => '<span class="color-dce icon icon-dyn-logo-dce"></span> ' . __('Conditionally run action', 'dynamic-content-for-elementor'), 'type' => \Elementor\Controls_Manager::SWITCHER]);
