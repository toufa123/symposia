...
class StripeField extends \ElementorPro\Modules\Forms\Fields\Field_Base
{
    ...
    public function render($item, $item_index, $form)
    {
        ...
        $form->add_render_attribute('dce_stripe' . $item_index, 'data-nonce', $nonce, \true);
