...
class DynamicCharts extends \DynamicContentForElementor\Widgets\WidgetPrototype
{
    ...
    protected function _register_controls_content()
    {
        ...
        $this->add_control('legend', ['label' => __('Legend', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::TEXT, 'frontend_available' => \true, 'default' => __('Population in milion', 'dynamic-content-for-elementor'), 'condition' => ['type!' => ['pie', 'doughnut']]]);
        ...
        $this->end_controls_section();
        $this->start_controls_section('section_options', ['label' => __('Options', 'dynamic-content-for-elementor'), 'condition' => ['type' => ['line', 'bar']]]);
        $this->add_control('begin_at_zero', ['label' => __('Begin at Zero', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER, 'frontend_available' => \true, 'default' => 'yes']);
