...
class DCE_Document_Prototype
{
    ...
    protected final function add_common_sections($element)
    {
        ...
        if ($post_type != 'elementor_library') {
            $element->start_controls_section($section_name, ['tab' => Controls_Manager::TAB_SETTINGS, 'label' => '<span class="color-dce icon icon-dyn-logo-dce pull-right ml-1"></span> ' . __('Page Scroll', 'dynamic-content-for-elementor')]);
