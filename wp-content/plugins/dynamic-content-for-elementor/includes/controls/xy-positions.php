 ...
 *
 */
class DCE_Control_XY_Positions extends Control_Base_Multiple
{
    /**
    ...
    {
        return ['x' => ['label' => __('X', 'dynamic-content-for-elementor'), 'min' => 0, 'max' => 100, 'step' => 1], 'y' => ['label' => __('Y', 'dynamic-content-for-elementor'), 'min' => 0, 'max' => 100, 'step' => 1]];
    }
    /**
