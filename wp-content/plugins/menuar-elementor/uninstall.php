...
use Merkulove\MenuarElementor\Unity\Cache;
use Merkulove\MenuarElementor\Unity\Helper;
use Merkulove\MenuarElementor\Unity\Plugin;
use Merkulove\MenuarElementor\UninstallHelper;
use Merkulove\MenuarElementor\Unity\EnvatoItem;
...
final class Uninstall {
    ...
    private function remove_settings() {
        ...
        foreach ( wp_load_alloptions() as $option => $value ) {
            if ( strpos( $option, 'mdp_menuar_elementor' ) === 0 ) {
                $settings[] = $option;
            }
        }
    ...
    public function get_uninstall_mode() {
        ...
        if ( isset( $uninstall_settings[ 'mdp_menuar_elementor_uninstall_settings' ] ) && $uninstall_settings[ 'mdp_menuar_elementor_uninstall_settings' ] ) { // Default value.
            $uninstall_settings = [
