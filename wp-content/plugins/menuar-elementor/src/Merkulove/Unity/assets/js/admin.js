...
( function ( $ ) {
    ...
    $( document ).ready( function () {
        ...
        let mdpMenuarElementor = window.mdpMenuarElementor;
        ...
        $checkUpdatesBtn.on( 'click', function ( e ) {
            ...
            let data = {
                ...
                nonce: mdpMenuarElementor.nonce,
                checkUpdates: true
            };

            /** Do AJAX request. */
            $.post( mdpMenuarElementor.ajaxURL, data, function( response ) {
