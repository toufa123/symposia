...
final class ReporterWordPress {
	...
	public function get_title() {
        ...
        return esc_html__( 'WordPress Environment', 'menuar-elementor' );
	...
	public function get_fields() {
		...
		return [
			'version'               => esc_html__( 'Version', 'menuar-elementor' ),
			'site_url'              => esc_html__( 'Site URL', 'menuar-elementor' ),
			'home_url'              => esc_html__( 'Home URL', 'menuar-elementor' ),
			'is_multisite'          => esc_html__( 'WP Multisite', 'menuar-elementor' ),
			'max_upload_size'       => esc_html__( 'Max Upload Size', 'menuar-elementor' ),
			'memory_limit'          => esc_html__( 'Memory limit', 'menuar-elementor' ),
			'permalink_structure'   => esc_html__( 'Permalink Structure', 'menuar-elementor' ),
			'language'              => esc_html__( 'Language', 'menuar-elementor' ),
			'timezone'              => esc_html__( 'Timezone', 'menuar-elementor' ),
			'admin_email'           => esc_html__( 'Admin Email', 'menuar-elementor' ),
			'debug_mode'            => esc_html__( 'Debug Mode', 'menuar-elementor' ),
		];
	...
	public function get_memory_limit() {
		...
		if ( $memory_limit_bytes < $min_recommended_bytes ) {
			$result['recommendation'] = esc_html__( 'We recommend setting memory to at least 64M. For more information, ask your hosting provider.', 'menuar-elementor' );
	...
	public function get_is_multisite() {
		...
		return [
			'value' => is_multisite() ? esc_html__( 'Yes', 'menuar-elementor' ) : esc_html__( 'No', 'menuar-elementor' )
		];
	...
	public function get_permalink_structure() {
		...
		if ( ! $structure ) {
			$structure = esc_html__( 'Plain', 'menuar-elementor' );
		}
	...
	public function get_debug_mode() {
		...
		return [
			'value' => WP_DEBUG ? esc_html__( 'Active', 'menuar-elementor' ) : esc_html__( 'Inactive', 'menuar-elementor' )
		];
