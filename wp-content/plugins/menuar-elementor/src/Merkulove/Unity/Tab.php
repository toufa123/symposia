...
abstract class Tab {
    ...
    protected function do_settings_base( $tab_slug = null ) {
        ...
        settings_fields( 'MenuarElementor' . $tab_slug . 'OptionsGroup' );
        do_settings_sections( 'MenuarElementor' . $tab_slug. 'OptionsGroup' );
    ...
    protected function add_settings_base( $tab_slug = null ) {
        ...
        /** Status Tab. */
        register_setting( 'MenuarElementor' . $tab_slug . 'OptionsGroup', 'mdp_menuar_elementor_' . $tab_slug . '_settings' );
        add_settings_section( 'mdp_menuar_elementor_' . $tab_slug . '_page_status_section', '', null, 'MenuarElementor' . $tab_slug . 'OptionsGroup' );
