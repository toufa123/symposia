...
final class PluginHelper {
	...
	public function add_row_meta( $links, $file ) {
		...
		$stars = esc_html__( 'Rate this plugin:', 'menuar-elementor' );
    ...
    public static function load_textdomain() {
        ...
        load_plugin_textdomain( 'menuar-elementor', false, Plugin::get_path() . '/languages/' );
