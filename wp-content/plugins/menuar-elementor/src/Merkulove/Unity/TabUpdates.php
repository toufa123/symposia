...
final class TabUpdates extends Tab {
	...
	public function add_settings() {
		...
		$group = 'MenuarElementor' . self::TAB_SLUG . 'OptionsGroup';
		$section = 'mdp_menuar_elementor_' . self::TAB_SLUG . '_page_status_section';

        /** Check for Updates button. */
        add_settings_field( 'check_updates', esc_html__( 'Check for updates:', 'menuar-elementor' ), [ $this, 'check_updates' ], $group, $section );

        /** Check SSL */
        add_settings_field( 'check_ssl', esc_html__( 'SSL verification:', 'menuar-elementor' ), [ $this, 'check_ssl' ], $group, $section );
    ...
    public function check_updates() {
        ...
        UI::get_instance()->render_button(
            esc_html__( 'Clear cache', 'menuar-elementor' ),
            '',
            'autorenew',
            [
                "name" => 'mdp_menuar_elementor_' . self::TAB_SLUG . '_settings' . "[check_updates]",
                "id" => "mdp-updates-btn",
    ...
    public function check_ssl() {
        ...
        UI::get_instance()->render_switcher(
            ...
            esc_html__( 'SSL verification', 'menuar-elementor' ),
            esc_html__( 'Enable to activate the SSL check when receiving updates', 'menuar-elementor' ),
            [
                "name" => 'mdp_menuar_elementor_' . self::TAB_SLUG . '_settings' . "[check_ssl]",
            ]
    ...
    public static function ajax_check_updates() {
        ...
        check_ajax_referer( 'menuar-elementor', 'nonce' );
