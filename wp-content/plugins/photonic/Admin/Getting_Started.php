			...
			<div class="photonic-header-nav">
				<div class="photonic-options-header-bar fix">
					<h2 class='nav-tab-wrapper'>
						...
						<a class='nav-tab' id='photonic-start-tab-create' href='#photonic-start-create'>Create Galleries</a>
						<a class='nav-tab' id='photonic-start-tab-layouts' href='#photonic-start-layouts'>Layouts</a>
						<a class='nav-tab' id='photonic-start-tab-lightbox' href='#photonic-start-lightbox'>Lightboxes</a>
		...
		<div id="photonic-start-create" class="photonic-start-panel">
			...
			<ol>
				<li>
					...
					<img src="<?php echo PHOTONIC_URL.'screenshot-2.jpg'; ?>" alt="'Add Media' Button"/><br/><br/>

					Correspondingly if you are using "Gutenberg" use the Photonic Gallery block:<br/>
					<img src="<?php echo PHOTONIC_URL.'screenshot-1.png'; ?>" alt="Gutenberg Block"/>
				</li>
						...
						<li>
							...
							<ol>
								<li>
									...
									<img src="<?php echo PHOTONIC_URL.'screenshot-5.jpg'; ?>" alt="Media Uploader"/><br/>
								</li>
								<li>
									Pick your source:<br/>
									<img src="<?php echo PHOTONIC_URL.'screenshot-6.jpg'; ?>" alt="Sources in Media Uploader"/><br/>
								</li>
								<li>
									Fill out the attributes for the gallery:<br/>
									<img src="<?php echo PHOTONIC_URL.'screenshot-8.png'; ?>" alt="Gallery attributes"/><br/>
								</li>
							</ol>
						</li>
						<li>
							...
							<ol>
								<li>
									...
									<img src="<?php echo PHOTONIC_URL.'screenshot-3.png'; ?>" alt="Wizard Starting Screen"/><br/>
								</li>
								<li>
									You will be shown a contextual set of options based on your choices:<br/>
									<img src="<?php echo PHOTONIC_URL.'screenshot-4.png'; ?>" alt="Contextual options in the Wizard"/><br/>
								</li>
							</ol>
						</li>
					</ol>
				...
				<li>
					...
					<img src="<?php echo PHOTONIC_URL.'screenshot-7.png'; ?>" alt="Gallery shows up with a placeholder"/>
				</li>
				<li>
	...
	function lightbox() {
		$lightboxes = [
			...
			'fancybox' => [
				...
				'supports' => ['autoStart', 'bundled', 'html5', 'touch', 'ytVimeo'],
				'license' => 'MIT, GPL',
			],
			'fancybox2' => [
				'name' => 'Fancybox2',
			...
			'lightGallery' => [
				...
				'size' => '~32KB JS, 21KB CSS, ~20KB Fonts, + Additional Plugins',
			...
			'prettyPhoto' => [
				...
				'supports' => ['autoStart', 'bundled', 'deepLinking', 'socialSharing', 'thumbnails', 'touch', 'ytVimeo'],
				'license' => 'GPL v2.0',
		...
		$lightboxes_json = json_encode($lightboxes);
		...
		<div id="photonic-start-lightbox" class="photonic-start-panel">
			...
			<table class="form-table photonic-form-table" id="photonic-lightboxes">
					...
					<td id="lightbox-features">
						<ul>
							...
							foreach ($supports as $feature => $text) {
								$item = "<label>\n";
								$item .= "\t<input type='checkbox' value='$feature'/>\n";
								$item .= "\t$text\n";
								$item .= "</label>\n";
								echo "<li>".$item."</li>\n";
							}
					...
					<td id="lightbox-list">
						<ul>
							...
							foreach ($lightboxes as $lb => $lightbox) {
								$item = '<button id="photonic-lb-button-'.$lb.'" style="border: none; cursor: pointer; "><span class="dashicons dashicons-forms"></span></button>';
								$item .= '<a href="'.$lightbox['url'].'">'.$lightbox['name'].'</a>';
								$item .= " ({$lightbox['size']}); ";
								$item .= " <strong>License</strong> &ndash; {$lightbox['license']}";
								if (!empty($lightbox['notes'])) {
									$item .= "; {$lightbox['notes']}";
								}
								echo "<li id='photonic-lb-$lb'>".$item."</li>\n";
							}
							?>
						</ul>
					</td>
				...
				<script type="text/javascript">
					document.addEventListener('DOMContentLoaded', function() {
						const lightboxes = <?php echo $lightboxes_json; ?>;
				...
				<li>
					...
					<ol>
						...
						<li>
							...
							<ol>
								<li><code>album_type='self'</code> - Prints out the user's Google Photos albums in tabular form</li>
								<li><code>album_type='shared'</code> - Prints out the all Google Photos albums shared with and by the user in tabular form</li>
							</ol>
						</li>
					</ol>
				</li>
