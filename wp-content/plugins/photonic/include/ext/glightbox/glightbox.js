  ...
  function slideVideo(slide, data, callback) {
    ...
    injectAssets(this.settings.plyr.js, 'Plyr', function () {
      ...
      //if (url.match(/\.(mp4|ogg|webm|mov)$/) !== null) {
        ...
        // Sayontan - changed to consider the 'data-format' on the 'a' element, if available. Also changed the code to use a URL Object instead of parsing the URL
    ...
    _createClass(GlightboxInit, [{
      ...
      value: function insertSlide() {
        ...
        if (this.slidesContainer) {
          ...
          // Changed by Sayontan... moved from outside "if (this.slidescontainer) {}" to inside
