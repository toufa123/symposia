...
/***/ "../include/ext/spotlight/spotlight.js":
/*!*********************************************!*\
  !*** ../include/ext/spotlight/spotlight.js ***!
  \*********************************************/
/*! unknown exports (runtime-defined) */
...
(function () {
  ...
  function Gb(a) {
    ...
    if (c) for (c = "string" === typeof c ? c.split(",") : c, e = 0; e < c.length; e++) {
      f = c[e].trim(), "scale" === f ? Ga = !0 : "fade" === f ? Ha = !0 : "slide" === f ? Ia = !0 : f && (J = f);
    }
    ya = D.fit;
    e = ja && ja.downlink;
    c = Math.max(na, u) * ka;
...
"use strict";
/* provided dependency */ var Spotlight = __webpack_require__(/*! ../../../../ext/spotlight/spotlight.js */ "../include/ext/spotlight/spotlight.js");
...
var PhotonicSpotlight = /*#__PURE__*/function (_Lightbox) {
  (0, _inherits2.default)(PhotonicSpotlight, _Lightbox);

  var _super = _createSuper(PhotonicSpotlight);

  function PhotonicSpotlight() {
    (0, _classCallCheck2.default)(this, PhotonicSpotlight);
    return _super.call(this);
  }

  (0, _createClass2.default)(PhotonicSpotlight, [{
    key: "hostedVideo",
    value: function hostedVideo(a) {
      ...
      if (html5 !== null && !css) {
        a.classList.add(Photonic_JS.slideshow_library + '-video');
        self.modifyAdditionalVideoProperties(a);
      }
    }
  }, {
    key: "changeVideoURL",
    value: function changeVideoURL(element, regular, embed, poster) {
      ...
      element.classList.remove(Photonic_JS.slideshow_library + "-video");
      element.classList.add(Photonic_JS.slideshow_library + "-embed-video");
    }
  }, {
    key: "modifyAdditionalVideoProperties",
    ...
    value: function initialize(selector) {
      ...
      document.addEventListener('click', function (e) {
        ...
        spotlight.show(gallery, {
          ...
          onchange: function onchange(idx, options) {
...
/******/ 	__webpack_require__("../include/js/front-end/src/Entries/Spotlight.js");
/******/ })()
;