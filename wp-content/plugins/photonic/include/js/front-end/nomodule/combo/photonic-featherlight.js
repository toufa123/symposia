...
/***/ "../include/ext/featherlight/featherlight.js":
/*!***************************************************!*\
  !*** ../include/ext/featherlight/featherlight.js ***!
  \***************************************************/
/*! unknown exports (runtime-defined) */
...
(function ($) {
  ...
  Featherlight.prototype = {
    ...
    setup: function setup(target, config) {
      ...
      if ((0, _typeof2.default)(target) === 'object' && target instanceof $ === false && !config) {
        config = target;
        target = undefined;
      }
  ...
  $.extend(Featherlight, {
    ...
    attach: function attach($source, $content, config) {
      ...
      if ((0, _typeof2.default)($content) === 'object' && $content instanceof $ === false && !config) {
        config = $content;
        $content = undefined;
      }
      /* make a copy */
...
/******/ 	__webpack_require__("../include/ext/featherlight/featherlight.js");
