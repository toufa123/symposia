...
/***/ "../include/ext/fancybox3/fancybox3.js":
/*!*********************************************!*\
  !*** ../include/ext/fancybox3/fancybox3.js ***!
  \*********************************************/
/*! unknown exports (runtime-defined) */
...
var PhotonicFancybox3 = /*#__PURE__*/function (_Lightbox) {
  (0, _inherits2.default)(PhotonicFancybox3, _Lightbox);

  var _super = _createSuper(PhotonicFancybox3);

  function PhotonicFancybox3($) {
    var _this;

    (0, _classCallCheck2.default)(this, PhotonicFancybox3);
    _this = _super.call(this);
    _this.$ = $;
    _this.buttons = [];

    if (Photonic_JS.fb3_zoom) {
      _this.buttons.push('zoom');
    }

    if (Photonic_JS.fb3_slideshow) {
      _this.buttons.push('slideShow');
    }

    if (Photonic_JS.fb3_fullscreen_button) {
      _this.buttons.push('fullScreen');
    }

    if (Photonic_JS.fb3_download) {
      _this.buttons.push('download');
    }

    if (Photonic_JS.fb3_thumbs_button) {
      _this.buttons.push('thumbs');
    }

    _this.buttons.push('close');

    return _this;
  }

  (0, _createClass2.default)(PhotonicFancybox3, [{
    key: "soloImages",
    value: function soloImages() {
      var $ = this.$;
      $('a[href]').filter(function () {
        return /(\.jpg|\.jpeg|\.bmp|\.gif|\.png)/i.test($(this).attr('href'));
      }).addClass("photonic-fancybox").addClass(Photonic_JS.slideshow_library);
    }
  }, {
    key: "hostedVideo",
...
/******/ 	__webpack_require__("../include/ext/fancybox3/fancybox3.js");
/******/ 	__webpack_require__("../include/js/front-end/src/Entries/Fancybox3.js");
/******/ })()
;