...
/***/ "../include/ext/magnific/magnific.js":
/*!*******************************************!*\
  !*** ../include/ext/magnific/magnific.js ***!
  \*******************************************/
/*! unknown exports (runtime-defined) */
...
var PhotonicMagnific = /*#__PURE__*/function (_Lightbox) {
  (0, _inherits2.default)(PhotonicMagnific, _Lightbox);

  var _super = _createSuper(PhotonicMagnific);

  function PhotonicMagnific($) {
    var _this;

    (0, _classCallCheck2.default)(this, PhotonicMagnific);
    _this = _super.call(this);
    _this.$ = $;

    _this.$.expr[':'].parents = function (a, i, m) {
  ...
  (0, _createClass2.default)(PhotonicMagnific, [{
    key: "initialize",
    ...
    key: "initializeForNewContainer",
    value: function initializeForNewContainer(selector) {
    ...
    key: "initializeSolos",
    value: function initializeSolos() {
      var self = this;
      var $ = self.$;
...
/******/ 	__webpack_require__("../include/ext/magnific/magnific.js");
/******/ 	__webpack_require__("../include/js/front-end/src/Entries/Magnific.js");
/******/ })()
;