...
/***/ "../include/ext/baguettebox/baguettebox.js":
/*!*************************************************!*\
  !*** ../include/ext/baguettebox/baguettebox.js ***!
  \*************************************************/
/*! unknown exports (runtime-defined) */
 ...
 *
 * Changes made by Sayontan Sinha to support the following:
 *  -   Videos, based on a modified version of the edits here: https://github.com/feimosi/baguetteBox.js/pull/137/files/12b0eeb3b334760026f86f9dc012af1aa000c99c
 *  -   Images & videos where the URL does not have a valid URL extension, via the data-content-type attribute
 */
...
(function (root, factory) {
  ...
  var touchFlag = false; // Changes by Sayontan according to https://github.com/feimosi/baguetteBox.js/pull/137/files/12b0eeb3b334760026f86f9dc012af1aa000c99c
  // Regex pattern to match image files
  // var regex = /.+\.(gif|jpe?g|png|webp)/i;
  // Regex pattern to match image & video files

  var regex = /.+\.(gif|jpe?g|png|webp|mp4|webm)/i; // Pattern to match only videos

  var videoRegex = /.+\.(mp4|webm)/i; // <-- End changes by Sayontan
  ...
  function hideOverlay() {
    ...
    setTimeout(function () {
      ...
      if (options.afterHide) {
        options.afterHide();
      } // Changes by Sayontan according to https://github.com/feimosi/baguetteBox.js/pull/137/files/12b0eeb3b334760026f86f9dc012af1aa000c99c


      pauseAnyVideoPlaying(); //<-- End changes by Sayontan
  ...
  function loadImage(index, callback) {
    ...
    var galleryItem = currentGallery[index]; // Changes by Sayontan according to https://github.com/feimosi/baguetteBox.js/pull/137/files/12b0eeb3b334760026f86f9dc012af1aa000c99c
    ...
    var imageElement = galleryItem.imageElement; // Changes by Sayontan according to https://github.com/feimosi/baguetteBox.js/pull/137/files/12b0eeb3b334760026f86f9dc012af1aa000c99c

    var thumbnailElement = isVideo ? imageElement.getElementsByTagName('video')[0] : imageElement.getElementsByTagName('img')[0]; //<-- End changes by Sayontan

    var imageCaption = typeof options.captions === 'function' ? options.captions.call(currentGallery, imageElement) : imageElement.getAttribute('data-caption') || imageElement.title; // Changes by Sayontan according to https://github.com/feimosi/baguetteBox.js/pull/137/files/12b0eeb3b334760026f86f9dc012af1aa000c99c

    var imageSrc = isVideo ? getVideoSrc(imageElement) : getImageSrc(imageElement); //<-- End changes by Sayontan
    ...
    imageContainer.appendChild(figure); // Changes by Sayontan according to https://github.com/feimosi/baguetteBox.js/pull/137/files/12b0eeb3b334760026f86f9dc012af1aa000c99c
...
/***/ "../include/ext/simplelightboxdb/simplelightboxdb.js":
/*!***********************************************************!*\
  !*** ../include/ext/simplelightboxdb/simplelightboxdb.js ***!
  \***********************************************************/
/*! unknown exports (runtime-defined) */
...
/**
 * Simple Lightbox by Damir Brekalo
...
/***/ "../include/js/front-end/src/Entries/SimpleLightboxDB.js":
/*!***************************************************************!*\
  !*** ../include/js/front-end/src/Entries/SimpleLightboxDB.js ***!
  \***************************************************************/
/*! unknown exports (runtime-defined) */
...
var _SimpleLightboxDB = __webpack_require__(/*! ../Lightboxes/SimpleLightboxDB */ "../include/js/front-end/src/Lightboxes/SimpleLightboxDB.js");
...
document.addEventListener('DOMContentLoaded', function () {
  var lightbox = new _SimpleLightboxDB.PhotonicSimpleLightboxDB();
...
/***/ "../include/js/front-end/src/Lightboxes/SimpleLightboxDB.js":
/*!******************************************************************!*\
  !*** ../include/js/front-end/src/Lightboxes/SimpleLightboxDB.js ***!
  \******************************************************************/
/*! flagged exports */
/*! export PhotonicSimpleLightboxDB [provided] [no usage info] [missing usage info prevents renaming] */
/*! export __esModule [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
/*! runtime requirements: __webpack_exports__, __webpack_require__ */
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
/* provided dependency */ var baguetteBox = __webpack_require__(/*! ../../../../ext/baguettebox/baguettebox.js */ "../include/ext/baguettebox/baguettebox.js");
...
exports.PhotonicSimpleLightboxDB = void 0;
...
var PhotonicSimpleLightboxDB = /*#__PURE__*/function (_Lightbox) {
  (0, _inherits2.default)(PhotonicSimpleLightboxDB, _Lightbox);

  var _super = _createSuper(PhotonicSimpleLightboxDB);

  function PhotonicSimpleLightboxDB() {
    (0, _classCallCheck2.default)(this, PhotonicSimpleLightboxDB);
    return _super.call(this);
  }

  (0, _createClass2.default)(PhotonicSimpleLightboxDB, [{
    key: "soloImages",
    value: function soloImages() {
      var solos = (0, _get2.default)((0, _getPrototypeOf2.default)(PhotonicSimpleLightboxDB.prototype), "soloImages", this).call(this);
      var idIndex = 1;
      solos.forEach(function (solo) {
        if (solo.getAttribute('id') == null) {
          solo.setAttribute('id', 'photonic-simplelightboxdb-' + idIndex);
          idIndex++;
        }
      });
    }
    ...
    key: "modifyAdditionalVideoProperties",
    value: function modifyAdditionalVideoProperties(anchor) {
      if (anchor != null && anchor instanceof Element && anchor.tagName === 'A') {
        ...
        if (anchor.getAttribute('id') == null) {
          anchor.setAttribute('id', 'photonic-simplelightboxdb-video-' + this.videoIndex);
          this.videoIndex++;
        }
      }
    }
    ...
    key: "initialize",
    value: function initialize(selector, destroy) {
      this.handleSolos();
      var self = this;
      var selection;
  ...
  return PhotonicSimpleLightboxDB;
}(_Lightbox2.Lightbox);

exports.PhotonicSimpleLightboxDB = PhotonicSimpleLightboxDB;
...
/******/ 	__webpack_require__("../include/ext/simplelightboxdb/simplelightboxdb.js");
/******/ 	__webpack_require__("../include/js/front-end/src/Entries/SimpleLightboxDB.js");
/******/ })()
;