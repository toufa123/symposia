...
var PhotonicBigPicture = /*#__PURE__*/function (_Lightbox) {
  (0, _inherits2.default)(PhotonicBigPicture, _Lightbox);

  var _super = _createSuper(PhotonicBigPicture);

  function PhotonicBigPicture() {
    (0, _classCallCheck2.default)(this, PhotonicBigPicture);
    return _super.call(this);
  }

  (0, _createClass2.default)(PhotonicBigPicture, [{
    key: "soloImages",
    value: function soloImages() {
      var solos = (0, _get2.default)((0, _getPrototypeOf2.default)(PhotonicBigPicture.prototype), "soloImages", this).call(this);
