...
/***/ "../include/ext/swipebox/swipebox.js":
/*!*******************************************!*\
  !*** ../include/ext/swipebox/swipebox.js ***!
  \*******************************************/
/*! unknown exports (runtime-defined) */
...
// Modifications to accept "sel" and selector as a parameter. elem.selector has been deprecated by jQuery. See https://github.com/brutaldesign/swipebox/issues/383#issuecomment-742130274
;
    ...
    plugin.init = function () {
      ...
      if (Array.isArray(elem)) {
        ...
        $(document).on('click', selector, function (event) {
          ...
          $elem.each(function () {
            var title = null,
                href = null; // Added by Sayontan Sinha
...
var PhotonicSwipebox = /*#__PURE__*/function (_Lightbox) {
  (0, _inherits2.default)(PhotonicSwipebox, _Lightbox);

  var _super = _createSuper(PhotonicSwipebox);

  function PhotonicSwipebox($) {
    var _this;

    (0, _classCallCheck2.default)(this, PhotonicSwipebox);
    _this = _super.call(this);
    _this.$ = $;
    return _this;
  }

  (0, _createClass2.default)(PhotonicSwipebox, [{
    key: "changeSlide",
    value: function changeSlide(thumb, idx) {
      var $ = this.$;
    ...
    value: function initialize(selector, group) {
      ...
      this.handleSolos();
      var self = this;
      $('a.photonic-swipebox').swipebox('a.photonic-swipebox', {
      ...
      $('a.swipebox-video').swipebox('a.swipebox-video', {
        hideBarsDelay: 0,
        removeBarsOnMobile: Photonic_JS.enable_swipebox_mobile_bars
      });
      $('a.swipebox-html5-video').swipebox('a.swipebox-html5-video', {
        hideBarsDelay: 0,
        removeBarsOnMobile: Photonic_JS.enable_swipebox_mobile_bars,
        videoURL: null,
        videoID: null,
...
/******/ 	__webpack_require__("../include/ext/swipebox/swipebox.js");
/******/ 	__webpack_require__("../include/js/front-end/src/Entries/Swipebox.js");
/******/ })()
;