...
/***/ "../include/ext/colorbox/colorbox.js":
/*!*******************************************!*\
  !*** ../include/ext/colorbox/colorbox.js ***!
  \*******************************************/
/*! unknown exports (runtime-defined) */
...
var PhotonicColorbox = /*#__PURE__*/function (_Lightbox) {
  (0, _inherits2.default)(PhotonicColorbox, _Lightbox);

  var _super = _createSuper(PhotonicColorbox);

  function PhotonicColorbox($) {
    var _this;

    (0, _classCallCheck2.default)(this, PhotonicColorbox);
    _this = _super.call(this);
    _this.$ = $;
    return _this;
  }

  (0, _createClass2.default)(PhotonicColorbox, [{
    key: "soloImages",
    value: function soloImages() {
      var $ = this.$;
      $('a[href]').filter(function () {
        return /(\.jpg|\.jpeg|\.bmp|\.gif|\.png)/i.test($(this).attr('href'));
      }).addClass("photonic-" + Photonic_JS.slideshow_library).addClass(Photonic_JS.slideshow_library).attr('data-photonic-media-type', 'image');
    }
  }, {
    key: "changeVideoURL",
...
/******/ 	__webpack_require__("../include/ext/colorbox/colorbox.js");
/******/ 	__webpack_require__("../include/ext/jquery.detect_swipe.js");
/******/ 	__webpack_require__("../include/js/front-end/src/Entries/Colorbox.js");
/******/ })()
;