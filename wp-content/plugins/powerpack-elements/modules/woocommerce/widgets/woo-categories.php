	...
	public function set_slider_attr() {
		...
		if ( $settings['slides_to_show_tablet'] || $settings['slides_to_show_mobile'] ) {
			...
			if ( $settings['slides_to_show_tablet'] ) {
				...
				$tablet_slides_scroll = ( isset( $settings['slides_to_scroll_tablet'] ) && $settings['slides_to_scroll_tablet'] ) ? absint( $settings['slides_to_scroll_tablet'] ) : $tablet_slides_show;
			...
			if ( $settings['slides_to_show_mobile'] ) {
				...
				$mobile_slides_scroll = ( isset( $settings['slides_to_scroll_mobile'] ) && $settings['slides_to_scroll_mobile'] ) ? absint( $settings['slides_to_scroll_mobile'] ) : $mobile_slides_show;
