...
abstract class Skin_Grid_Base extends Skin_Base {
	...
	public function set_slider_attr() {
		...
		$slick_options['prevArrow'] = '<div class="pp-slider-arrow slick-prev slick-arrow">' . self::render_arrow_icon('fa fa-angle-left') . '</div>';
		$slick_options['nextArrow'] = '<div class="pp-slider-arrow slick-next slick-arrow">' . self::render_arrow_icon('fa fa-angle-right') . '</div>';
		...
		$tablet_scroll = ( isset( $settings['slides_to_scroll_tablet'] ) && $settings['slides_to_scroll_tablet'] ) ? absint( $settings['slides_to_scroll_tablet'] ) : $tablet_show;
		$mobile_scroll = ( isset( $settings['slides_to_scroll_mobile'] ) && $settings['slides_to_scroll_mobile'] ) ? absint( $settings['slides_to_scroll_mobile'] ) : $mobile_show;
	...
	protected static function render_arrow_icon( $network_name ) {
		$network_icon_data = self::get_network_icon_data( $network_name );
