	...
	protected function register_style_button_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '',
				'selectors' => array(
					'{{WRAPPER}} .pp-tiled-post-button:hover' => 'background-color: {{VALUE}}',
				),
				'condition' => array(
					'read_more_button' => 'yes',
				),
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '',
				'selectors' => array(
					'{{WRAPPER}} .pp-tiled-post-button:hover' => 'color: {{VALUE}}',
				),
				'condition' => array(
					'read_more_button' => 'yes',
				),
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '',
				'selectors' => array(
					'{{WRAPPER}} .pp-tiled-post-button:hover' => 'border-color: {{VALUE}}',
				),
				'condition' => array(
					'read_more_button' => 'yes',
				),
		...
		$this->add_group_control(
			...
			array(
				...
				'selector'  => '{{WRAPPER}} .pp-tiled-post-button:hover',
				'condition' => array(
					'read_more_button' => 'yes',
				),
			)
