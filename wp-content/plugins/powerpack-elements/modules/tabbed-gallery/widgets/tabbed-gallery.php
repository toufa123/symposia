...
class Tabbed_Gallery extends Powerpack_Widget {
	...
	protected function render() {
		...
		$this->add_render_attribute( 'carousel-wrap', [
			'class' => [ 'swiper-container', 'pp-swiper-slider', 'pp-tabbed-gallery-carousel', 'swiper-container-' . esc_attr( $this->get_id() ) ],
		] );
			...
			<div class="pp-tabbed-gallery-wrapper">
				...
				<div <?php echo wp_kses_post( $this->get_render_attribute_string( 'carousel' ) ); ?>>
					<div <?php echo wp_kses_post( $this->get_render_attribute_string( 'carousel-wrap' ) ); ?>>
						<div <?php echo wp_kses_post( $this->get_render_attribute_string( 'swiper-wrap' ) ); ?>>
	...
	public function slider_settings() {
		...
		$margin                  = ( isset( $settings['columns_gap']['size'] ) && $settings['columns_gap']['size'] ) ? absint( $settings['columns_gap']['size'] ) : 10;
		$margin_tablet           = ( isset( $settings['columns_gap_tablet']['size'] ) && $settings['columns_gap_tablet']['size'] ) ? absint( $settings['columns_gap_tablet']['size'] ) : 10;
		$margin_mobile           = ( isset( $settings['columns_gap_mobile']['size'] ) && $settings['columns_gap_mobile']['size'] ) ? absint( $settings['columns_gap_mobile']['size'] ) : 10;
	...
	protected function render_gallery_items() {
		...
		foreach ( $photos as $photo ) {
			...
			<div class="pp-tabbed-carousel-slide swiper-slide <?php echo esc_attr( $final_tab_label ); ?>" data-item-id="<?php echo esc_attr( $photo->id ); ?>">
