	...
	<?php if ( 'off' == $settings['hide_wl_settings'] ) { ?>
		<table class="form-table">
			<tbody>
				...
				<tr valign="top">
					<th scope="row" valign="top">
						<?php esc_html_e( 'Plugin Short Name', 'powerpack' ); ?>
					</th>
					<td>
						<input id="pp_plugin_short_name" name="pp_plugin_short_name" type="text" class="regular-text" value="<?php esc_attr_e( $settings['plugin_short_name'], 'powerpack' ); ?>" />
					</td>
				</tr>
				<tr valign="top">
					<th scope="row" valign="top">
