...
class Premium_Iconbox extends Widget_Base {
	...
	protected function register_controls() { // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .premium-icon-box-icon, {{WRAPPER}} .premium-icon-box-icon-container svg, {{WRAPPER}} .premium-icon-box-icon-container img, {{WRAPPER}} .premium-icon-box-animation'  => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .premium-icon-box-icon, {{WRAPPER}} .premium-icon-box-icon-container svg, {{WRAPPER}} .premium-icon-box-icon-container img, {{WRAPPER}} .premium-icon-box-animation',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-icon-box-icon, {{WRAPPER}} .premium-icon-box-icon-container svg, {{WRAPPER}} .premium-icon-box-icon-container img, {{WRAPPER}} .premium-icon-box-animation' => 'border-radius: {{SIZE}}{{UNIT}};',
				),
				'condition'  => array(
					'icon_adv_radius!' => 'yes',
				),
		...
		$this->add_control(
			...
			array(
				...
				'dynamic'   => array( 'active' => true ),
				'selectors' => array(
					'{{WRAPPER}} .premium-icon-box-icon, {{WRAPPER}} .premium-icon-box-icon-container svg, {{WRAPPER}} .premium-icon-box-icon-container img, {{WRAPPER}} .premium-icon-box-animation' => 'border-radius: {{VALUE}};',
				),
				'condition' => array(
					'icon_adv_radius' => 'yes',
				),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-icon-box-icon, {{WRAPPER}} .premium-icon-box-icon-container svg, {{WRAPPER}} .premium-icon-box-icon-container img, {{WRAPPER}} .premium-icon-box-animation' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-icon-box-icon, {{WRAPPER}} .premium-icon-box-icon-container svg, {{WRAPPER}} .premium-icon-box-icon-container img, {{WRAPPER}} .premium-icon-box-animation' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}}:hover .premium-icon-box-icon, {{WRAPPER}}:hover svg, {{WRAPPER}}:hover .premium-icon-box-icon-container img, {{WRAPPER}}:hover .premium-icon-box-animation' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}}:hover .premium-icon-box-icon, {{WRAPPER}}:hover svg, {{WRAPPER}}:hover .premium-icon-box-icon-container img, {{WRAPPER}}:hover .premium-icon-box-animation',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}}:hover .premium-icon-box-icon, {{WRAPPER}}:hover svg, {{WRAPPER}}:hover .premium-icon-box-icon-container img, {{WRAPPER}}:hover .premium-icon-box-animation' => 'border-radius: {{SIZE}}{{UNIT}};',
				),
				'condition'  => array(
		...
		$this->add_control(
			...
			array(
				...
				'dynamic'   => array( 'active' => true ),
				'selectors' => array(
					'{{WRAPPER}}:hover .premium-icon-box-icon, {{WRAPPER}}:hover svg, {{WRAPPER}}:hover .premium-icon-box-icon-container img, {{WRAPPER}}:hover .premium-icon-box-animation' => 'border-radius: {{VALUE}};',
				),
				'condition' => array(
					'icon_hover_adv_radius' => 'yes',
				),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}}:hover .premium-icon-box-icon, {{WRAPPER}}:hover svg, {{WRAPPER}}:hover .premium-icon-box-icon-container img, {{WRAPPER}}:hover .premium-icon-box-animation' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}}:hover .premium-icon-box-icon, {{WRAPPER}}:hover svg, {{WRAPPER}}:hover .premium-icon-box-icon-container img, {{WRAPPER}}:hover .premium-icon-box-animation' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}.premium-icon-box-whole-text-yes:hover .premium-icon-box-more, {{WRAPPER}} .premium-icon-box-more:hover .premium-icon-box-more'   => 'color: {{VALUE}};',
					'{{WRAPPER}}.premium-icon-box-whole-text-yes:hover .premium-icon-box-more svg, {{WRAPPER}} .premium-icon-box-more:hover .premium-icon-box-more svg'   => 'fill: {{VALUE}} !important',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}}.premium-icon-box-whole-text-yes:hover .premium-icon-box-more, {{WRAPPER}} .premium-icon-box-more:hover .premium-icon-box-more',
			)
		);
	...
	protected function render() {
		...
		$this->add_render_attribute( 'title', 'class', 'premium-icon-box-title' );
		...
		$this->add_render_attribute( 'label', 'class', 'premium-icon-box-label' );
		...
		<div class="premium-icon-box-container-in <?php echo esc_attr( $flex_pos ) . ' ' . esc_attr( $flex_ver_pos ); ?>" >
			...
			<?php if ( 'yes' === $settings['premium_icon_box_title_switcher'] || 'yes' === $settings['premium_icon_box_desc_switcher'] ) : ?>
				...
				<?php if ( 'yes' === $settings['premium_icon_box_title_switcher'] && ! empty( $title ) ) : ?>
						...
						<<?php echo wp_kses_post( $heading ) . ' ' . wp_kses_post( $this->get_render_attribute_string( 'title' ) ); ?>><?php echo wp_kses_post( $settings['premium_icon_box_title'] ); ?>
						<?php if ( ! empty( $settings['premium_icon_box_label'] ) ) : ?>
							<span <?php echo wp_kses_post( $this->get_render_attribute_string( 'label' ) ); ?> ><?php echo wp_kses_post( $settings['premium_icon_box_label'] ); ?></span>
						<?php endif; ?>
	...
	protected function content_template() {
		...
		<#
			...
			var title = settings.premium_icon_box_title,
				...
				view.addRenderAttribute('title', 'class', 'premium-icon-box-title' );

				view.addInlineEditingAttributes( 'title', 'basic' );

				view.addRenderAttribute('label','class', 'premium-icon-box-label' );
				...
				<div {{{ view.getRenderAttributeString('outer_wrap') }}}>
					<# if( 'yes' === settings.premium_icon_box_title_switcher || 'yes' === settings.premium_icon_box_desc_switcher ) { #>
						...
						<# if( 'yes' === settings.premium_icon_box_title_switcher && '' != title ) { #>
								...
								<{{{titleTag}}} {{{ view.getRenderAttributeString('title') }}}>{{{ settings.premium_icon_box_title }}}
									<# if( '' != settings.premium_icon_box_label ) { #>
										<span {{{ view.getRenderAttributeString('label') }}} >{{{ settings.premium_icon_box_label }}}</span>
									<# } #>
								</{{{titleTag}}}>
						<# } #>
