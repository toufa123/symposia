	...
	protected function register_controls() { // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		...
		$this->add_control(
			...
			array(
				...
				'type'               => Controls_Manager::SWITCHER,
				'description'        => __( 'Enable this option to automatically navigate between tabs. Automatic navigation will stop once a tab is clicked by the user.', 'premium-addons-for-elementor' ),
				'return_value'       => 'true',
				'condition'          => array(
					'carousel_tabs!' => 'true',
				),
