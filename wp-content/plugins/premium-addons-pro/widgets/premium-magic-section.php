	...
	protected function register_controls() { // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .premium-magic-section-btn svg' => 'fill: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .premium-magic-section-btn, {{WRAPPER}} .premium-magic-section-icon-wrap svg, {{WRAPPER}} .premium-magic-section-button-trig svg'   => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .premium-magic-section-btn, {{WRAPPER}} .premium-magic-section-icon-wrap svg, {{WRAPPER}} .premium-magic-section-button-trig svg',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .premium-magic-section-btn, {{WRAPPER}} .premium-magic-section-icon-wrap svg, {{WRAPPER}} .premium-magic-section-button-trig svg'     => 'border-radius: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-magic-section-btn, {{WRAPPER}} .premium-magic-section-icon-wrap svg, {{WRAPPER}} .premium-magic-section-button-trig svg' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .premium-magic-section-btn:hover svg' => 'fill: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .premium-magic-section-icon-wrap:hover svg, {{WRAPPER}} .premium-magic-section-button-trig:hover svg' => 'fill: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .premium-magic-section-btn:hover, {{WRAPPER}} .premium-magic-section-icon-wrap:hover svg, {{WRAPPER}} .premium-magic-section-button-trig:hover svg' => 'background: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .premium-magic-section-btn:hover, {{WRAPPER}} .premium-magic-section-icon-wrap:hover svg, {{WRAPPER}} .premium-magic-section-button-trig:hover svg',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-magic-section-btn:hover, {{WRAPPER}} .premium-magic-section-icon-wrap:hover svg, {{WRAPPER}} .premium-magic-section-button-trig:hover svg' => 'border-radius:{{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-magic-section-btn:hover, {{WRAPPER}} .premium-magic-section-icon-wrap:hover svg, {{WRAPPER}} .premium-magic-section-button-trig:hover svg' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				),
			)
		);
