                ...
                $.each(settings.items, function (index, layout) {
                    ...
                    if (null !== layout["premium_parallax_layer_image"]["url"] && "" !== layout["premium_parallax_layer_image"]["url"]) {
                        ...
                        var backgroundImage = layout["premium_parallax_layer_image"]["url"],
                            alt = layout['alt'],
                            left = undefined !== layout["premium_parallax_layer_hor_pos" + deviceSuffix] ? layout["premium_parallax_layer_hor_pos" + deviceSuffix].size : layout["premium_parallax_layer_hor_pos"].size,
                            top = undefined !== layout["premium_parallax_layer_ver_pos" + deviceSuffix] ? layout["premium_parallax_layer_ver_pos" + deviceSuffix].size : layout["premium_parallax_layer_ver_pos"].size,
                            width = undefined !== layout["premium_parallax_layer_width" + deviceSuffix] ? layout["premium_parallax_layer_width" + deviceSuffix].size : layout["premium_parallax_layer_width"].size,
                            $html = $(
