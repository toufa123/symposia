    ...
    $(window).on('elementor/frontend/init', function () {
        ...
        var PremiumTabsHandler = ModuleHandler.extend({
            ...
            run: function () {
                ...
                $premiumTabsElem.data("navigation").forEach(function (item) {
        ...
        var PremiumColorTransitionHandler = ModuleHandler.extend({
                        ...
                        elementorFrontend.waypoint(
                            ...
                            function (direction) {
                                ...
                                if ('down' === direction) {
                                    ...
                                    console.log(element + " " + downOffsets[index]);
                                }
                            }, {
                        ...
                        elementorFrontend.waypoint(
                            ...
                            function (direction) {
                                if ('up' === direction) {
                                    ...
                                    console.log(element + " " + upOffsets[index]);
                                }
                            }, {
            ...
            getRepeaterSettings: function () {
                ...
                console.log(downOffsets, upOffsets);
                return {
                    elements: elements,
