...
class uipress_admin_pages
{
  ...
  public function uip_admin_page_options()
  {
    ...
    <div class="uip-margin-top-s">
      <div class="uip-margin-bottom-s uip-flex uip-flex-column">
        <span class="uip-text-muted uip-margin-right-s uip-margin-bottom-xs uip-text-bold"><?php _e("Apply to subsites", $this->textDomain); ?></span>
    ...
    ?>
    <div class="uip-margin-top-s">
      <span class="uip-text-muted uip-text-bold"><?php _e("Menu Icon", $this->textDomain); ?>:</span>
    </div>
    ...
    <div class="uip-margin-top-s">
      <div class="uip-margin-bottom-s uip-flex uip-flex-column">
        <span class="uip-text-muted uip-margin-right-s uip-margin-bottom-xs uip-text-bold"><?php _e("Manually add to menu?", $this->textDomain); ?></span>
        <label class="uip-switch">
  ...
  public function admin_pages_settings_options($settings, $network)
  {
    ...
    $category["label"] = __("Admin Pages - Beta", $this->textDomain);
    $category["description"] = __("Creates custom admin pages.", $this->textDomain);
    $category["icon"] = "segment";

    $temp = [];
    $temp["name"] = __("Disable custom admin pages?", $this->textDomain);
    $temp["description"] = __("If disabled, the admin pages will not be available to any users.", $this->textDomain);
    $temp["type"] = "switch";
    ...
    $temp = [];
    $temp["name"] = __("Admin Page Slug", $this->textDomain);
    $temp["description"] = __("This defaults to admin-pages. Changes to this will need you to resave permalink structure.", $this->textDomain);
    $temp["type"] = "text";
    ...
    $temp = [];
    $temp["name"] = __("Who can edit and create admin pages?", $this->textDomain);
    $temp["description"] = __("Editing and creation of admin pages will be disabled for the users or roles you select", $this->textDomain);
    ...
    $temp = [];
    $temp["name"] = __("Who can see admin pages?", $this->textDomain);
    $temp["description"] = __("UiPress will only show admin pages for the users or roles you select", $this->textDomain);
    $temp["type"] = "user-role-select";
  ...
  public function uipress_create_admin_page_cpt()
  {
    ...
    $labels = [
      ...
      "add_new" => _x("Add New", "Admin Page", $this->textDomain),
