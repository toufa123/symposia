...
class uipress_app
{
  ...
  public function menu_actions_front()
  {
    ...
    add_action("wp_head", [$this, "output_menu_front"]);
    add_action("wp_footer", [$this, "output_admin_menu_front"]);
  ...
  public function html_attributes_front($output, $doctype)
  {
    if (stripos($_SERVER["SCRIPT_NAME"], strrchr(wp_login_url(), "/")) == false) {
      ...
      $toolbar = $utils->get_option("toolbar", "load-front");
  ...
  public function get_translations()
  {
    ...
    $translations["isActivated"] = sprintf(__("%s Pro is active", $this->textDomain), $this->pluginName);
    $translations["uipressPro"] = sprintf(__("%s Pro", $this->textDomain), $this->pluginName);
    ...
    $translations["selected"] = __("selected", $this->textDomain);
  ...
  public function get_app_settings_options($settings, $network)
  {
    ...
    $temp = [];
    $temp["name"] = __("Disable dark mode", $this->textDomain);
    $temp["description"] = __("If enabled, dark mode switch will not be available.", $this->textDomain);
    $temp["type"] = "switch";
    ...
    $temp = [];
    $temp["name"] = sprintf(__("Rename %s", $this->textDomain), $this->pluginName);
    $temp["description"] = sprintf(__("White label %s by changing the name displayed.", $this->textDomain), $this->pluginName);
    $temp["type"] = "text";
    ...
    $temp = [];
    $temp["name"] = sprintf(__("App Icon", $this->textDomain), $this->pluginName);
    $temp["description"] = sprintf(__("Replace %s plugin icon with your own", $this->textDomain), $this->pluginName);
    $temp["type"] = "image";
    ...
    $temp = [];
    $temp["name"] = sprintf(__("Admin Favicon", $this->textDomain), $this->pluginName);
    $temp["description"] = __("Add an image to be used as the site favicon for admin pages.", $this->textDomain);
    $temp["type"] = "image";
    ...
    $temp = [];
    $temp["name"] = sprintf(__("Hide %s from plugin table", $this->textDomain), $this->pluginName);
    $temp["description"] = sprintf(__("If enabled, %s will be hidden from the plugin table", $this->textDomain), $this->pluginName);
    $temp["type"] = "switch";
    ...
    $temp["description"] = sprintf(__("%s menu will be disabled for any users or roles you select", $this->textDomain), $this->pluginName);
    ...
    $temp = [];
    $temp["name"] = sprintf(__("Load %s Menu on front end", $this->textDomain), $this->pluginName);
    $temp["description"] = sprintf(__("If enabled, %s menu will load on the front end. Please note, this will not work on all themes and styling will vary", $this->textDomain), $this->pluginName);
    $temp["type"] = "switch";
    $temp["premium"] = true;
    ...
    $temp = [];
    $temp["name"] = sprintf(__("Only Load %s Menu on front end for", $this->textDomain), $this->pluginName);
    $temp["description"] = sprintf(__("Only load front end menu for selected roles and usernames", $this->textDomain), $this->pluginName);
    $temp["type"] = "user-role-select";
    $temp["premium"] = true;
    ...
    $temp["description"] = sprintf(__("%s toolbar module will be disabled for any users or roles you select", $this->textDomain), $this->pluginName);
    $temp["type"] = "user-role-select";
    $temp["optionName"] = "disabled-for";
    $temp["premium"] = true;
    $temp["value"] = $this->get_option_value_from_object($allOptions, $moduleName, $temp["optionName"], true);
    ...
    $temp = [];
    $temp["name"] = sprintf(__("Load %s admin bar on front end", $this->textDomain), $this->pluginName);
    $temp["description"] = sprintf(__("If enabled, %s toolbar will load on the front end. Please note, this will not work on all themes and styling will vary", $this->textDomain), $this->pluginName);
    $temp["type"] = "switch";
    $temp["premium"] = true;
    $temp["optionName"] = "load-front";
    $temp["value"] = $this->get_option_value_from_object($allOptions, $moduleName, $temp["optionName"]);
    ...
    $temp["description"] = sprintf(__("%s will hide all notifications from all users except those selected below", $this->textDomain), $this->pluginName);
    $temp["type"] = "user-role-select";
    ...
    $temp["description"] = sprintf(__("%s will hide all updates from all users except those selected below", $this->textDomain), $this->pluginName);
    $temp["type"] = "user-role-select";
    ...
    $temp = [];
    $temp["name"] = __("Disable Language Selector", $this->textDomain);
    $temp["description"] = __("Removes the language selector added to the login page", $this->textDomain);
    $temp["type"] = "switch";
