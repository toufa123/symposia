...
class uipress_styles extends uipress_app
{
  ...
  public function add_menu_item()
  {
    ...
    add_options_page($this->pluginName, $this->pluginName . " " . __("Styles", $this->textDomain), "manage_options", "uip-styles", [$this, "build_settings_page"]);
  }
  ...
  public function get_styles_object()
  {
    ...
    $temp = [];
    $temp["name"] = __("Text Emphasis Color", $this->textDomain);
    $temp["type"] = "color";
    ...
    $temp = [];
    $temp["name"] = __("Text Muted Color", $this->textDomain);
    $temp["type"] = "color";
    ...
    ///DANGER BUTTON
    $temp = [];
    $temp["name"] = __("Danger Button Border Colour", $this->textDomain);
    $temp["type"] = "color";
    ...
    $temp = [];
    $temp["name"] = __("Danger Button Background Colour", $this->textDomain);
    $temp["type"] = "color";
    ...
    $temp = [];
    $temp["name"] = __("Danger Button Hover Background Colour", $this->textDomain);
    $temp["type"] = "color";
    ...
    $temp = [];
    $temp["name"] = __("Danger Button Text Colour", $this->textDomain);
    $temp["type"] = "color";
