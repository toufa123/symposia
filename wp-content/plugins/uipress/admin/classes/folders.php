...
class uipress_folders
{
  ...
  public function folder_settings_options($settings, $network)
  {
    ...
    $temp["description"] = __("No media folders will be displayed when this option is activated.", $this->textDomain);
    $temp["type"] = "switch";
    ...
    $temp["description"] = sprintf(__("%s folders will be disabled for any users or roles you select", $this->textDomain), $this->pluginName);
