<div class="wpabstracts container-fluid">
	<h3>
		<?php echo apply_filters('wpabstracts_title_filter', __('New Review','wpabstracts'), 'new_review'); ?>
	...
	<form method="post" enctype="multipart/form-data" id="wpabs_review_form">
		<div class="wpabstracts row">
			<div class="wpabstracts col-xs-12 col-sm-12 col-md-8">
				...
				<div class="wpabstracts panel panel-default">
					<div class="wpabstracts panel-heading">
						<h5><?php echo apply_filters('wpabstracts_title_filter', __('Add Comments','wpabstracts'), 'add_comments');?></h5>
					</div>
				...
				<?php if(get_option('wpabstracts_review_attachments')){ ?>
					<div class="wpabstracts panel panel-default">
						...
						<div class="wpabstracts panel-body">
							...
							<dl class="wpabstracts form-group">
								<dd>
									<input type="file" name="review_attachment">
								</dd>
							</dl>
						</div>
					</div>
			...
			<div class="wpabstracts col-xs-12 col-md-4">
					...
					<div class="wpabstracts panel panel-default">
						<div class="wpabstracts panel-heading">
							<strong><?php echo apply_filters('wpabstracts_title_filter', __('Suggest Type', 'wpabstracts'), 'suggest_type'); ?></strong>
						</div>
						<div class="wpabstracts panel-body" id="abs_recommendation_error">
							<div class="wpabstracts radio">
								...
								foreach($presenter_preference as $preference){ ?>
									<label class="wpabstracts radio"><input type='radio' name='abs_recommendation' value='<?php echo $preference; ?>' /> <?php echo $preference; ?></label>
								<?php } ?>
							</div>
						</div>
					</div>
					...
					<div class="wpabstracts panel panel-default">
						<div class="wpabstracts panel-heading">
							<strong><?php echo apply_filters('wpabstracts_title_filter', __('Suggest Status', 'wpabstracts'), 'suggest_status'); ?></strong>
						</div>
						<div class="wpabstracts panel-body" id="abs_status_error">
							<div class="wpabstracts radio">
								<?php $statuses = wpabstracts_get_statuses(); ?>
								<?php foreach($statuses as $status){ ?>
									<label class="wpabstracts radio"><input type='radio' name='abs_status' value='<?php echo $status->id;?>' /> <?php echo $status->name;?></label>
								<?php } ?>
							</div>
						</div>
					</div>
					...
					<div class="wpabstracts panel panel-default">
						<div class="wpabstracts panel-heading">
							<strong><?php echo apply_filters('wpabstracts_title_filter', __('Additional Information', 'wpabstracts'), 'additional_information'); ?></strong>
						</div>
						<div class="wpabstracts panel-body">
