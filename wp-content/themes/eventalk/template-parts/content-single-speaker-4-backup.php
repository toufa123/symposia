                            ...
                            <ul>                         
                                <li><i class="fa fa-calendar"></i> <?php echo esc_html( date_i18n( $date_format, strtotime($selected_event[0]['session_start_date']))); ?>
                                  ...
                                  if ( defined( 'ICL_LANGUAGE_CODE' )){   
                                      ...
                                      <?php   echo esc_html($time_in_12_hour_format)  = date("g:i a", strtotime( $selected_event[0]['session_start_time']));
                                      ?> -
                                        <?php   echo esc_html($time_in_12_hour_format)  = date("g:i a", strtotime( $selected_event[0]['session_end_time']));
                                      ?>
                                      <?php   } else {  ?>
