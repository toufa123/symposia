...
<div id="post-<?php the_ID(); ?>" <?php post_class( 'team-single' ); ?>>
  ...
  <?php  if ( RDTheme::$options['schedule_label_display'] == 'label_meta'  ) {   ?> 
    ...
    <?php 
                    ...
                    $inner_content = '<table class="table table-bordered table-responsive">
                        <tbody>';
                            ...
                            if(!in_array($datetime->format('Ymd'), array_keys($tabArray))){
                                    ...
                                    $tcontent = '<li class="nav-item '.$tabNall.'">';
                                    $tcontent .= '<a class="'.$tabActive.'" href="#schedule-'.$datetime->format('Ymd').'" data-toggle="tab" aria-expanded="true">';
                                    $tcontent .= ' <div class="day-number">'. $item['schedule_label'] .'</div>';                                
                                    $tcontent .= '<div class="schedule-date">'. $datetime->format('Y-m-d').'</div>';
                                    $tcontent .= '</a></li>';
                                    $tabArray[$datetime->format('Ymd')] =     $tcontent;                                               
                                }          
       ...
       // }       
     printf('<div class="schedule-layout3 schedule-layout6-new">
              ...
              $tabNall =  $difday==0 ? 'tab-btn-nall': null;
                ...
                $tabs .='<li class="nav-item '.$tabNall.'">              
                            <a class="'.$tabActive.'" href="#schedule-'.$datetime->format('Ymd').'" data-toggle="tab" aria-expanded="true">
                                ...
                                <div class="schedule-date">'. $datetime->format('Y-m-d').'</div>
                            </a>
                        </li>';
